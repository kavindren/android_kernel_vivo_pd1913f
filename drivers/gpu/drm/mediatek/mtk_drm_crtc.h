...
struct mtk_drm_crtc {
	...
	/* vivo changliang add for display common source library begin */
	struct workqueue_struct *fingerprint_workq;
	struct delayed_work fingerprint_notify_work;
	int fingershooter_status;
	/* vivo changliang add for display common source library end */
	bool vblank_en;
...
struct mtk_crtc_state {
	...
	bool doze_changed;
	/* vivo changliang add for display common source library start */
	int shooter_flag;
	/* vivo changliang add for display common source library end */
};
...
int mtk_drm_crtc_set_panel_hbm(struct drm_crtc *crtc, int en);
