...
static bool         port_read_flag;
static unsigned int modem_data_irq;
...
/*add by zhangzhangong for vivo_pem start*/
#if defined (CONFIG_PEM_NET_REQUEST) && !defined (CONFIG_PEM_DRIVERS_MODULE)
void set_port_read(bool flag)
{
	port_read_flag = flag;
}
EXPORT_SYMBOL(set_port_read);

bool is_port_read(void)
{
	return port_read_flag;
}
#endif //CONFIG_PEM_NET_REQUEST
/*add by zhangzhangong for vivo_pem end*/
