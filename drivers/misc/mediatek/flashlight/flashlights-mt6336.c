 ...
 *****************************************************************************/
static int mt6336_ioctl(struct i2c_client * client, unsigned int cmd, unsigned long arg)
{
...
static int mt6336_set_driver(struct i2c_client * client, int set)
{
	int ret = 0;
...
static ssize_t mt6336_strobe_store(struct i2c_client * client, struct flashlight_arg arg)
{
	mt6336_set_driver(client, 1);
