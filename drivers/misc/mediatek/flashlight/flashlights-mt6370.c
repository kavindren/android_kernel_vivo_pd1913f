 ...
 *****************************************************************************/
static int mt6370_ioctl(struct i2c_client * client, unsigned int cmd, unsigned long arg)
{
...
static int mt6370_set_driver(struct i2c_client * client, int set)
{
	int ret = 0;
...
static ssize_t mt6370_strobe_store(struct i2c_client * client, struct flashlight_arg arg)
{
	mt6370_set_driver(client, 1);
	if (arg.decouple)
		mt6370_set_scenario(
