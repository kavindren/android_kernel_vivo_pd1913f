 ...
 *****************************************************************************/
static int rt5081_ioctl(struct i2c_client * client, unsigned int cmd, unsigned long arg)
{
...
static int rt5081_set_driver(struct i2c_client * client, int set)
{
	int ret = 0;
...
static ssize_t rt5081_strobe_store(struct i2c_client * client, struct flashlight_arg arg)
{
	rt5081_set_driver(client, 1);
	rt5081_set_scenario(
