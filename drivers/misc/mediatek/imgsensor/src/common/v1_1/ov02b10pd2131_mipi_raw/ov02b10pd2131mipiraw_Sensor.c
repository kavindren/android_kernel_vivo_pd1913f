...
#define PFX "MAIN2[002B]_camera_sensor"
...
static struct imgsensor_info_struct imgsensor_info = {
	...
	.sensor_id = OV02B10PD2131_SENSOR_ID,
...
extern int MAIN3_002B_otp_read_pd2131(void);
extern otp_error_code_t OV02B10PD2131_OTP_ERROR_CODE;
MUINT32  sn_inf_main3_ov02b10pd2131[13];  /*0 flag   1-12 data*/
MUINT32  material_inf_main3_ov02b10pd2131[4];  
		...
		do {
			*sensor_id = return_sensor_id()+1;
			if (*sensor_id == imgsensor_info.sensor_id) {
				...
				vivo_otp_read_when_power_on = MAIN3_002B_otp_read_pd2131();
				pr_debug("read eeprom ---vivo_otp_read_when_power_on = %d,SUB2_2375_OTP_ERROR_CODE=%d\n", vivo_otp_read_when_power_on, OV02B10PD2131_OTP_ERROR_CODE);
				#endif
					return ERROR_NONE;
			}
	...
	case SENSOR_FEATURE_GET_CUSTOM_INFO:
		...
		switch (*feature_data) {
			...
			if (*feature_para_len >= sizeof(MUINT32)*13 + 2) {
			    *(MUINT32 *)(uintptr_t)((feature_data+1)) = OV02B10PD2131_OTP_ERROR_CODE;//otp_state
				memcpy( feature_data+2, sn_inf_main3_ov02b10pd2131, sizeof(MUINT32)*13); 
				memcpy(feature_data+10, material_inf_main3_ov02b10pd2131, sizeof(MUINT32)*4);
				#if 0
						for (i = 0 ; i<12 ; i++ ){
						printk("sn_inf_sub2_ov02b10pd2131[%d]= 0x%x\n", i, sn_inf_sub2_ov02b10pd2131[i]);
						}
				#endif
			}
				break;
...
UINT32 OV02B10PD2131_MIPI_RAW_SensorInit(
