...
#include "ov02b10pd2163mipiraw_Sensor.h"
...
static unsigned char main3_otp_data_ov02b10[VIVO_MAIN3_OTP_DATA_SIZE];
...
extern MUINT32  sn_inf_main3_ov02b10[13];
extern MUINT32  material_inf_main3_ov02b10[4];  
...
int MAIN3_002B_otp_read(void)
{
	...
	for (i = 0; i < VIVO_MAIN3_OTP_DATA_SIZE; i++) {
		if (!vivo_read_eeprom(offset,  &main3_otp_data_ov02b10[i])) {
			LOG_INF("read_vivo_eeprom 0x%0x %d fail \n", offset,  main3_otp_data_ov02b10[i]);
			return 0;
		}
	...
	#if 0
	for(i = 0; i < VIVO_MAIN3_OTP_DATA_SIZE; i++) {
		LOG_INF("read_vivo_eeprom Data[0x%0x]:0x%x\n", i,  main3_otp_data_ov02b10[i]);
	}
	#endif
	
	/*check_if_group_valid = main3_otp_data_ov02b10[ModuleInfo_addr] | main3_otp_data_ov02b10[Awb_addr] | main3_otp_data_ov02b10[Af_addr] | main3_otp_data_ov02b10[Lsc_addr] | main3_otp_data_ov02b10[PD_Proc1_addr] | main3_otp_data_ov02b10[PD_Proc2_addr];*/
	if ((0x01 == main3_otp_data_ov02b10[ModuleInfo_addr]) &&
		(0x01 == main3_otp_data_ov02b10[SN_addr]) && 
		(0x01 == main3_otp_data_ov02b10[Awb_addr]) && 
		(0x01 == main3_otp_data_ov02b10[Lsc_addr])  ) {
	...
	if (check_if_group_valid == 0x01) { /****all the data is valid****/
		/****ModuleInfo****/
		if (  (0x04!= main3_otp_data_ov02b10[0x01]) && ( 0x03!= main3_otp_data_ov02b10[0x01])) {
			OV02B10_OTP_ERROR_CODE = OTP_ERROR_CODE_MODULE_INFO_ERROR;
			LOG_INF("Module ID error!!!    otp_error_code:%d\n", OV02B10_OTP_ERROR_CODE);
			return 0;
		} else if (((0x14 != main3_otp_data_ov02b10[0x0008]) && (0x10 != main3_otp_data_ov02b10[0x0008])) || 
			(VIVO_MAIN3_VENDOR_VCM_ID != main3_otp_data_ov02b10[0x0009]) || 
			(VIVO_MAIN3_VENDOR_DRIVERIC_ID != main3_otp_data_ov02b10[0x000A]) || 
			(VIVO_MAIN3_VENDOR_PLATFORM_ID != main3_otp_data_ov02b10[0x0002])) {
			
			OV02B10_OTP_ERROR_CODE = OTP_ERROR_CODE_MODULE_INFO_ERROR;
			LOG_INF(": Platform ID or Lens or VCM ID or Driver_IC ID  Error!!!    otp_error_code:%d\n", OV02B10_OTP_ERROR_CODE);
			return 0;
		} else if ((0xff != main3_otp_data_ov02b10[0x000B]) || 
			(0x00 != main3_otp_data_ov02b10[0x000C]) || 
			(0x0b != main3_otp_data_ov02b10[0x000D]) || 
			(0x01 != main3_otp_data_ov02b10[0x000E])) {
			OV02B10_OTP_ERROR_CODE = OTP_ERROR_CODE_MODULE_INFO_ERROR;
			LOG_INF(": calibration version  Error!!!    Read version:0x%2x%2x%2x%2x\n", 
				main3_otp_data_ov02b10[0x000B], main3_otp_data_ov02b10[0x000C], main3_otp_data_ov02b10[0x000D], main3_otp_data_ov02b10[0x000E]);
			return 0;
		}
		...
		for (i = ModuleInfo_addr+1; i < ModuleInfo_checksum_addr; i++) {
			checksum += main3_otp_data_ov02b10[i];
			}
			checksum = checksum % 0xff+1;
		if (main3_otp_data_ov02b10[ModuleInfo_checksum_addr] != checksum) {
		...
		/****material info start****/
			material_inf_main3_ov02b10[0] = (MUINT32)main3_otp_data_ov02b10[0x0F];
			material_inf_main3_ov02b10[1] = (MUINT32)main3_otp_data_ov02b10[0x10];
			material_inf_main3_ov02b10[2] = (MUINT32)main3_otp_data_ov02b10[0x11];
			material_inf_main3_ov02b10[3] = (MUINT32)main3_otp_data_ov02b10[0x12];
			/*LOG_INF("material_inf_main3_ov02b10[0] = 0x%x, material_inf_main3_ov02b10[1] = 0x%x, material_inf_main3_ov02b10[2] = 0x%x,material_inf_main3_ov02b10[3] = 0x%x\n",
				material_inf_main3_ov02b10[0]  , material_inf_main3_ov02b10[1],  material_inf_main3_ov02b10[2], material_inf_main3_ov02b10[3]);*/
		/****material info end****/
		...
		for (i = Fuse_id_addr+1; i < Fuse_id_checksum_addr; i++) {
			...
			checksum = checksum % 0xff+1;
		if (main3_otp_data_ov02b10[Fuse_id_checksum_addr] != checksum) {
			OV02B10_OTP_ERROR_CODE = OTP_ERROR_CODE_CHECKSUM_ERROR;
		...
		for (i = SN_addr+1; i < SN_checksum_addr; i++) {
			/*LOG_INF("main3_otp_data_ov02b10[0x%x] = 0x%x\n", i, main3_otp_data_ov02b10[i]);*/
			checksum += main3_otp_data_ov02b10[i];
			}
			checksum = checksum % 0xff+1;
		if (main3_otp_data_ov02b10[SN_checksum_addr] != checksum) {
			OV02B10_OTP_ERROR_CODE = OTP_ERROR_CODE_CHECKSUM_ERROR;
			LOG_INF("SN_checksum error!!!   otp_error_code:%d\n", OV02B10_OTP_ERROR_CODE);
			return 0;
		}
		sn_inf_main3_ov02b10[0] = 0x01;
		for (i = 0; i < 12; i++) {
			sn_inf_main3_ov02b10[i +1] = (MUINT32)main3_otp_data_ov02b10[i + SN_addr+1];
			/*LOG_INF("sn_inf_main3_ov02b10[%d] = 0x%x, main3_otp_data_ov02b10[0x%x] = 0x%x\n", i+1  , sn_inf_main3_ov02b10[i +1],  i +SN_addr+1, main3_otp_data_ov02b10[i + SN_addr+1]);*/
		}
		...
		for (i = Awb_addr+1; i < Awb_checksum_addr; i++) {
			...
			checksum = checksum % 0xff+1;
		if (main3_otp_data_ov02b10[Awb_checksum_addr] != checksum) {
			OV02B10_OTP_ERROR_CODE = OTP_ERROR_CODE_CHECKSUM_ERROR;
		...
		for (i = Af_addr+1; i < Af_checksum_addr; i++) {
			...
			checksum = checksum % 0xff+1;
		if (main3_otp_data_ov02b10[Af_checksum_addr] != checksum) {
			OV02B10_OTP_ERROR_CODE = OTP_ERROR_CODE_CHECKSUM_ERROR;
		...
		for (i = Lsc_addr+1; i < Lsc_checksum_addr; i++) {
			...
			checksum = checksum % 0xff+1;
		if (main3_otp_data_ov02b10[Lsc_checksum_addr] != checksum) {
			OV02B10_OTP_ERROR_CODE = OTP_ERROR_CODE_CHECKSUM_ERROR;
		...
		for (i = PDAF_proc1_addr+1; i < PDAF_proc1_checksum_addr; i++) {
			...
			checksum = checksum % 0xff+1;
		if (main3_otp_data_ov02b10[PDAF_proc1_checksum_addr] != checksum) {
			OV02B10_OTP_ERROR_CODE = OTP_ERROR_CODE_CHECKSUM_ERROR;
		...
		for (i = PDAF_proc2_addr+1; i < PDAF_proc2_checksum_addr; i++) {
			...
			checksum = checksum % 0xff+1;
		if (main3_otp_data_ov02b10[PDAF_proc2_checksum_addr] != checksum) {
			OV02B10_OTP_ERROR_CODE = OTP_ERROR_CODE_CHECKSUM_ERROR;
			LOG_INF("PDAF_data_checksum error!!!   otp_error_code:%d\n", OV02B10_OTP_ERROR_CODE);
			return 0;
		}
		...
		R_unit = main3_otp_data_ov02b10[Awb_addr+1];
		R_unit = (R_unit << 8) | (main3_otp_data_ov02b10[Awb_addr+2]);
		B_unit = main3_otp_data_ov02b10[Awb_addr+3];
		B_unit = (B_unit << 8) | (main3_otp_data_ov02b10[Awb_addr+4]);
		G_unit = main3_otp_data_ov02b10[Awb_addr+5];
		G_unit = (G_unit << 8) | (main3_otp_data_ov02b10[Awb_addr+6]);

		R_golden = main3_otp_data_ov02b10[Awb_addr+7];
		R_golden = (R_golden << 8) | (main3_otp_data_ov02b10[Awb_addr+8]);
		B_golden = main3_otp_data_ov02b10[Awb_addr+9];
		B_golden = (B_golden << 8) | (main3_otp_data_ov02b10[Awb_addr+10]);
		G_golden = main3_otp_data_ov02b10[Awb_addr+11];
		G_golden = (G_golden << 8) | (main3_otp_data_ov02b10[Awb_addr+12]);
		...
		R_unit_low = main3_otp_data_ov02b10[Awb_addr+13];
		R_unit_low = (R_unit_low << 8) | (main3_otp_data_ov02b10[Awb_addr+14]);
		B_unit_low = main3_otp_data_ov02b10[Awb_addr+15];
		B_unit_low = (B_unit_low << 8) | (main3_otp_data_ov02b10[Awb_addr+16]);
		G_unit_low = main3_otp_data_ov02b10[Awb_addr+17];
		G_unit_low = (G_unit_low << 8) | (main3_otp_data_ov02b10[Awb_addr+18]);

		R_golden_low = main3_otp_data_ov02b10[Awb_addr+19];
		R_golden_low = (R_golden_low << 8) | (main3_otp_data_ov02b10[Awb_addr+20]);
		B_golden_low = main3_otp_data_ov02b10[Awb_addr+21];
		B_golden_low = (B_golden_low << 8) | (main3_otp_data_ov02b10[Awb_addr+22]);
		G_golden_low = main3_otp_data_ov02b10[Awb_addr+23];
		G_golden_low = (G_golden_low << 8) | (main3_otp_data_ov02b10[Awb_addr+24]);
		...
		AF_inf  =  main3_otp_data_ov02b10[Af_addr+2];
		AF_inf = (AF_inf << 8) | (main3_otp_data_ov02b10[Af_addr+3]);

		AF_mac = main3_otp_data_ov02b10[Af_addr+4];
		AF_mac = (AF_mac << 8) | (main3_otp_data_ov02b10[Af_addr+5]);
		...
		/*for(i = 0;i < 1372;i++)
		{
			...
			if(i < 496)
				PDAF_data[i] = main3_otp_data_ov02b10[PD_Proc1_addr+i+1];
			else //i >= 496
				PDAF_data[i] = main3_otp_data_ov02b10[PD_Proc1_addr+i+3];
		}*/
		/*copy pdaf data*/
		/*memcpy(PDAF_data, &main3_otp_data_ov02b10[PDAF_addr+1], PDAF_checksum_addr-PDAF_addr-1);*/
