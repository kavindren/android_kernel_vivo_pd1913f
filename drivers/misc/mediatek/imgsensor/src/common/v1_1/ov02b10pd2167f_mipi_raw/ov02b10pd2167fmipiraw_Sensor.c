 ...
 * Filename:
 * ---------
 *	 ov02b10pd2167fmipiraw_Sensor.c
 *
 * Project:
 * --------
 *	 ALPS
...
static struct imgsensor_info_struct imgsensor_info = {
	...
	.sensor_id = OV02B10PD2167F_SENSOR_ID,
...
extern otp_error_code_t OV02B10PD2167F_OTP_ERROR_CODE;
#endif
MUINT32  sn_inf_main3_ov02b10pd2167f[13];  /*0 flag   1-12 data*/
MUINT32  material_inf_main3_ov02b10pd2167f[4];
...
static kal_uint32 get_imgsensor_id(UINT32 *sensor_id)
{
	...
	kal_uint8 timeout = 0;
	timeout = check_i2c_timeout(0xfd, imgsensor.i2c_write_id);
	if (timeout) {
		...
		do {
			*sensor_id = return_sensor_id();
			if (*sensor_id == imgsensor_info.sensor_id) {
				...
				pr_debug("read eeprom ---vivo_otp_read_when_power_on = %d,MAIN3_002B_OTP_ERROR_CODE=%d\n", vivo_otp_read_when_power_on, OV02B10PD2167F_OTP_ERROR_CODE);
...
/*
    ...
    */
	...
	case SENSOR_FEATURE_GET_CUSTOM_INFO:
	    printk("SENSOR_FEATURE_GET_CUSTOM_INFO information type:%lld  MAIN3_2375_OTP_ERROR_CODE:%d \n", *feature_data,OV02B10PD2167F_OTP_ERROR_CODE);
		switch (*feature_data) {
			...
			if (*feature_para_len >= sizeof(MUINT32)*13 + 2) {
			    *(MUINT32 *)(uintptr_t)(*(feature_data+1)) = OV02B10PD2167F_OTP_ERROR_CODE;//otp_state
				memcpy( feature_data+2, sn_inf_main3_ov02b10pd2167f, sizeof(MUINT32)*13); 
                memcpy( feature_data+10, material_inf_main3_ov02b10pd2167f, sizeof(MUINT32)*4);
				#if 0
					for (i = 0 ; i<12 ; i++ ){
						printk("sn_inf_main3_ov02b10pd2167f[%d]= 0x%x\n", i, sn_inf_main3_ov02b10pd2167f[i]);
					}
				#endif
			}
				break;
...
UINT32 OV02B10PD2167F_MIPI_RAW_SensorInit(
