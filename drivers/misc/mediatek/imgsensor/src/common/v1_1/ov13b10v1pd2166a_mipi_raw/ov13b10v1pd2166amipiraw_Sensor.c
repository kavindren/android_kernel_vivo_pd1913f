 ...
 *============================================================================
 ****************************************************************************/
#define PFX "OV13B10V1PD2166A_camera_sensor"
...
#include "ov13b10v1pd2166amipiraw_Sensor.h"
...
static struct imgsensor_info_struct imgsensor_info = {
	.sensor_id = OV13B10V1PD2166A_SENSOR_ID,
...
static struct SENSOR_WINSIZE_INFO_STRUCT imgsensor_winsize_info[10] = {
	...
	{4224, 3136,  0,  0,  4224, 3136, 4224, 3136,   8,   384, 4208, 3120, 0, 0, 4208, 2368},  //normal video
...
extern int ov13b10v1pd2166a_vivo_otp_read(void);
static int vivo_otp_read_when_power_on = 0;
MUINT32  sn_inf_main_ov13b10v1pd2166a[13];  /*0 flag   1-12 data*/
MUINT32  material_inf_main_ov13b10v1pd2166a[4];  
extern otp_error_code_t OV13B10V1PD2166A_OTP_ERROR_CODE;
extern bool ov13b10v1pd2166a_vivo_read_eeprom(kal_uint16 addr,  BYTE *data);
extern unsigned int is_atboot;
extern unsigned  int ov13b10v1pd2166a_flag;
...
static kal_uint16 ov13b10v1pd2166a_table_write_cmos_sensor(
...
#endif
#if MULTI_WRITE
kal_uint16 addr_data_pair_init_ov13b10v1pd2166a[] = {
0x0103, 0x01,
0x0303, 0x02,
0x0305, 0x56,
0x0321, 0x00,
...
static void sensor_init(void)
{
	...
	mdelay(10);
	LOG_INF("MULTI_WRITE\n");
	ov13b10v1pd2166a_table_write_cmos_sensor(
		addr_data_pair_init_ov13b10v1pd2166a,
		sizeof(addr_data_pair_init_ov13b10v1pd2166a) / sizeof(kal_uint16));
	LOG_INF("sensor_init() end\n");
}	/*	sensor_init  */

#if MULTI_WRITE
kal_uint16 addr_data_pair_preview_ov13b10v1pd2166a[] = {
	0x0305, 0x2b,
	0x0327, 0x04,
	0x3501, 0x06,
	0x3502, 0x10,
...
static void preview_setting(void)
{
	...
	ov13b10v1pd2166a_table_write_cmos_sensor(
		addr_data_pair_preview_ov13b10v1pd2166a,
		sizeof(addr_data_pair_preview_ov13b10v1pd2166a) / sizeof(kal_uint16));

	LOG_INF("preview_setting() end\n");
}	/*	preview_setting  */

#if MULTI_WRITE
kal_uint16 addr_data_pair_capture_15fps_ov13b10v1pd2166a[] = {
	0x0305, 0x56,
	0x0327, 0x05,
	0x3501, 0x0c,
	0x3502, 0x10,
...
kal_uint16 addr_data_pair_capture_30fps_ov13b10v1pd2166a[] = {
	0x0305, 0x56,
	0x0327, 0x05,
	0x3501, 0x0c,
	0x3502, 0x10,
...
static void capture_setting(kal_uint16 currefps)
{
	...
	if (currefps == 150) {
		ov13b10v1pd2166a_table_write_cmos_sensor(
			addr_data_pair_capture_15fps_ov13b10v1pd2166a,
			sizeof(addr_data_pair_capture_15fps_ov13b10v1pd2166a) /
			sizeof(kal_uint16));
	} else {
		ov13b10v1pd2166a_table_write_cmos_sensor(
			addr_data_pair_capture_30fps_ov13b10v1pd2166a,
			sizeof(addr_data_pair_capture_30fps_ov13b10v1pd2166a) /
			sizeof(kal_uint16));
	}
}

#if MULTI_WRITE
kal_uint16 addr_data_pair_video_ov13b10v1pd2166a[] = {
	0x0305, 0x56,
	0x0327, 0x05,
	0x3501, 0x0c,
	0x3502, 0x10,
...
static void normal_video_setting(kal_uint16 currefps)
{
	...
	ov13b10v1pd2166a_table_write_cmos_sensor(
		addr_data_pair_video_ov13b10v1pd2166a,
		sizeof(addr_data_pair_video_ov13b10v1pd2166a) /
		sizeof(kal_uint16));
}
...
#if MULTI_WRITE
kal_uint16 addr_data_pair_hs_video_ov13b10v1pd2166a[] = {
	0x0305, 0x2b,
	0x0327, 0x04,
	0x3501, 0x03,
	0x3502, 0x00,
...
#endif
#if MULTI_WRITE
kal_uint16 addr_data_pair_slim_video_ov13b10v1pd2166a[] = {
	0x0305, 0x2b,
	0x0327, 0x04,
	0x3501, 0x03,
	0x3502, 0x00,
...
static void hs_video_setting(void)
{
	...
	ov13b10v1pd2166a_table_write_cmos_sensor(
		addr_data_pair_hs_video_ov13b10v1pd2166a,
		sizeof(addr_data_pair_hs_video_ov13b10v1pd2166a) /
		sizeof(kal_uint16));
}
...
static void slim_video_setting(void)
{
	...
	ov13b10v1pd2166a_table_write_cmos_sensor(
		addr_data_pair_slim_video_ov13b10v1pd2166a,
		sizeof(addr_data_pair_slim_video_ov13b10v1pd2166a) /
		sizeof(kal_uint16));
...
#if 1
kal_uint16 addr_data_pair_custom2_ov13b10v1pd2166a[] = {
	0x0305, 0x2b, 
	0x0327, 0x05,
	0x3501, 0x06, 
	0x3502, 0x00, 
...
static void custom2_setting(kal_uint16 currefps)
{
	...
	ov13b10v1pd2166a_table_write_cmos_sensor(
		addr_data_pair_custom2_ov13b10v1pd2166a,
		sizeof(addr_data_pair_custom2_ov13b10v1pd2166a) /
		sizeof(kal_uint16));
}
#else
static void custom2_setting(kal_uint16 currefps)
...
static kal_uint32 get_imgsensor_id(UINT32 *sensor_id)
{
	kal_uint8 i = 0, j = 0;
	kal_uint8 retry = 2;
	unsigned char material_inf_ov13b10v1pd2166a[4] ={0,0,0,0};
    int offset = 0x0010;
	...
	while (imgsensor_info.i2c_addr_table[i] != 0xff) {
		...
		do {
	  		...
	  		for(j = 0;j < 4;j++)
				{
					ov13b10v1pd2166a_vivo_read_eeprom(offset,&material_inf_ov13b10v1pd2166a[j]);
					PK_DBG("vivo_material_inf_ov13b10v1pd2166a[%d]=0x%x",j,material_inf_ov13b10v1pd2166a[j] );
					offset++;
				} 
				PK_DBG("i2c write id: 0x%x, sensor id: 0x%x material_inf_ov13b10v1pd2166a=0x%x\n", imgsensor.i2c_write_id,*sensor_id,((unsigned int)material_inf_ov13b10v1pd2166a[0]<<24|(unsigned int)material_inf_ov13b10v1pd2166a[1]<<16|(unsigned int)material_inf_ov13b10v1pd2166a[2]<<8|(unsigned int)material_inf_ov13b10v1pd2166a[3]));  
      			//*sensor_id = imgsensor_info.sensor_id;
	  			if((unsigned int)material_inf_ov13b10v1pd2166a[3] == 0x58){
				...
				vivo_otp_read_when_power_on = ov13b10v1pd2166a_vivo_otp_read();
				pr_debug("start read eeprom ---vivo_otp_read_when_power_on = %d\n", vivo_otp_read_when_power_on);
				pr_debug("read eeprom ---vivo_otp_read_when_power_on = %d,MAIN_F8D1_OTP_ERROR_CODE=%d\n", vivo_otp_read_when_power_on, OV13B10V1PD2166A_OTP_ERROR_CODE);
				return ERROR_NONE;
			}
			}else{
				pr_err("material_inf_ov13b10v1pd2166a[3]=0x%x != 0x58",material_inf_ov13b10v1pd2166a[3] );
                                *sensor_id = 0xFFFFFFFF;
                                return ERROR_SENSOR_CONNECT_FAIL;
			}
		#else
				 ...
				 UINT8 *feature_para, UINT32 *feature_para_len)
{
	...
	case SENSOR_FEATURE_GET_CUSTOM_INFO:
    	printk("SENSOR_FEATURE_GET_CUSTOM_INFO information type:%lld  OV13B10V1PD2166A_OTP_ERROR_CODE:%d \n", *feature_data,OV13B10V1PD2166A_OTP_ERROR_CODE);
		switch (*feature_data) {
			case 0:    //info type: otp state
				...
				if (*feature_para_len >= sizeof(MUINT32)*13 + 2) {
					*(MUINT32 *)(uintptr_t)(*(feature_data+1)) = OV13B10V1PD2166A_OTP_ERROR_CODE;//otp_state
					memcpy( feature_data+2, sn_inf_main_ov13b10v1pd2166a, sizeof(MUINT32)*13); 	
					memcpy( feature_data+10, material_inf_main_ov13b10v1pd2166a, sizeof(MUINT32)*4); 
					#if 0
						for (i = 0 ; i<13 ; i++ ){
						printk("sn_inf_main_ov13b10v1pd2166a[%d]= 0x%x\n", i, sn_inf_main_ov13b10v1pd2166a[i]);
						}
...
UINT32 OV13B10V1PD2166A_MIPI_RAW_SensorInit(struct SENSOR_FUNCTION_STRUCT **pfFunc)
{
