...
#include "ov8856pd2163mipiraw_freq.h"
...
static struct imgsensor_info_struct imgsensor_info = {
	.sensor_id = OV8856PD2163_SENSOR_ID,
	...
	.custom6 = {          //for sensor s5khm2sp03 vsdof
		.pclk = 143870000,
		.linelength  = 2464,
		.framelength = 1944,
		.startx = 0,
	...
	.custom7 = {           //for second sensor skgw1sd vsdof
		.pclk = 143870000,
		.linelength  = 2464,
		.framelength = 1944,
		.startx = 0,
...
static struct SENSOR_WINSIZE_INFO_STRUCT imgsensor_winsize_info[13] = {
	...
	{ 3264, 2448,   512,    384, 2240, 1680, 2240, 1680, 0, 0, 2240, 1680,  0,  0, 2240, 1680}, // custom7
...
extern int MAIN2_885A_otp_read_qtech(void);
extern int MAIN2_885A_otp_read_truly(void);
otp_error_code_t OV8856PD2163_OTP_ERROR_CODE = OTP_ERROR_CODE_NORMAL;
MUINT32  sn_inf_main2_ov8856pd2163[13];  /*0 flag   1-12 data*/
MUINT32  material_inf_main2_ov8856pd2163[4];
...
static bool vivo_read_eeprom_ov8856pd2163(kal_uint16 addr,  BYTE *data)
{
...
static void set_shutter(kal_uint32 shutter)
{
	...
	PK_DBG("vivo ov8856 set_shutter  = %d\n", shutter);
		...
		do {
			*sensor_id = ((read_cmos_sensor_16_8(0x300B) << 8) | read_cmos_sensor_16_8(0x300C));
			if (*sensor_id == imgsensor_info.sensor_id) {
				...
				vivo_read_eeprom_ov8856pd2163(0x0001, &eeprom_module_id);
				if(eeprom_module_id == 0x05){
					vivo_otp_read_when_power_on = MAIN2_885A_otp_read_qtech();
				}else{
					vivo_otp_read_when_power_on = MAIN2_885A_otp_read_truly();
				}
				pr_debug("read eeprom ---vivo_otp_read_when_power_on = %d,MAIN2_885A_OTP_ERROR_CODE=%d\n", vivo_otp_read_when_power_on, OV8856PD2163_OTP_ERROR_CODE);
	...
	case SENSOR_FEATURE_GET_CUSTOM_INFO:
		...
		switch (*feature_data) {
			...
			if (*feature_para_len >= sizeof(MUINT32)*13 + 2) {
			    *(MUINT32 *)(uintptr_t)(*(feature_data+1)) = OV8856PD2163_OTP_ERROR_CODE;//otp_state
				memcpy( feature_data+2, sn_inf_main2_ov8856pd2163, sizeof(MUINT32)*13);
				memcpy( feature_data+10, material_inf_main2_ov8856pd2163, sizeof(MUINT32)*4);
				#if 0
						for (i = 0 ; i<12 ; i++ ){
...
UINT32 OV8856PD2163_MIPI_RAW_SensorInit(
