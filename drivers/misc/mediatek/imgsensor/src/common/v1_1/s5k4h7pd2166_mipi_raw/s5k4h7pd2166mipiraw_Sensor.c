...
#define PFX "S5K4H7PD2166_camera_sensor"
...
#include "s5k4h7pd2166mipiraw_Sensor.h"
...
static struct imgsensor_info_struct imgsensor_info = {
      .sensor_id = S5K4H7PD2166_SENSOR_ID,
...
extern int S5K4H7PD2166_otp_read(void);
int vivo_sub_otp_read_when_power_on_s5k4h7pd2166;
extern otp_error_code_t S5K4H7PD2166_OTP_ERROR_CODE;
#endif
extern unsigned int is_atboot;
MUINT32  sn_inf_sub_s5k4h7pd2166[13];  /*0 flag   1-12 data*/
MUINT32  material_inf_sub_s5k4h7pd2166[4];  /*0 flag   1-12 data*/
...
kal_uint16 addr_data_pair_init_s5k4h7pd2166[] = {
0x0100, 0x00,
0x0B05, 0x01,
0x3074, 0x06,
0x3075, 0x2F,
...
kal_uint16 addr_data_pair_preview_s5k4h7pd2166[] = {
0x0136, 0x1A,
0x0137, 0x00,
0x0305, 0x04,
0x0306, 0x00,
...
kal_uint16 addr_data_pair_capture_s5k4h7pd2166[] = {
0x0136, 0x1A,
0x0137, 0x00,
0x0305, 0x04,
0x0306, 0x00,
...
kal_uint16 addr_data_pair_normal_video_s5k4h7pd2166[] = {
0x0136, 0x1A,
0x0137, 0x00,
0x0305, 0x04,
0x0306, 0x00,
...
kal_uint16 addr_data_pair_hs_video_s5k4h7pd2166[] = {
0x0136, 0x1A,
0x0137, 0x00,
0x0305, 0x04,
0x0306, 0x00,
...
kal_uint16 addr_data_pair_slim_video_s5k4h7pd2166[] = {
0x0136, 0x1A,
0x0137, 0x00,
0x0305, 0x04,
0x0306, 0x00,
...
kal_uint16 addr_data_pair_custom1_s5k4h7pd2166[] = {
0x0136, 0x1A,
0x0137, 0x00,
0x0305, 0x04,
0x0306, 0x00,
...
kal_uint16 addr_data_pair_custom2_s5k4h7pd2166[] = {
0x0136, 0x1A,
0x0137, 0x00,
0x0305, 0x04,
0x0306, 0x00,
...
kal_uint16 addr_data_pair_custom3_s5k4h7pd2166[] = {
0x0136, 0x1A,
0x0137, 0x00,
0x0305, 0x04,
0x0306, 0x00,
...
kal_uint16 addr_data_pair_custom4_s5k4h7pd2166[] = {
0x0136, 0x1A,
0x0137, 0x00,
0x0305, 0x04,
0x0306, 0x00,
...
kal_uint16 addr_data_pair_custom5_s5k4h7pd2166[] = {
0x0136, 0x1A,
0x0137, 0x00,
0x0305, 0x04,
0x0306, 0x00,
...
{	
  ...
  table_write_cmos_sensor(addr_data_pair_init_s5k4h7pd2166,
                          sizeof(addr_data_pair_init_s5k4h7pd2166) / sizeof(kal_uint16));
}				/*      sensor_init  */

static void preview_setting(void)
{	
  pr_debug("preview_setting() E\n");
  table_write_cmos_sensor(addr_data_pair_preview_s5k4h7pd2166,
                          sizeof(addr_data_pair_preview_s5k4h7pd2166) / sizeof(kal_uint16));
}				/*      preview_setting  */
...
static void capture_setting(kal_uint16 currefps)
{
  ...
  table_write_cmos_sensor(addr_data_pair_capture_s5k4h7pd2166,
                          sizeof(addr_data_pair_capture_s5k4h7pd2166) / sizeof(kal_uint16));
}
...
static void normal_video_setting(kal_uint16 currefps)
{
  ...
  table_write_cmos_sensor(addr_data_pair_normal_video_s5k4h7pd2166,
                          sizeof(addr_data_pair_normal_video_s5k4h7pd2166) / sizeof(kal_uint16));
}

static void hs_video_setting(void)
{
  pr_debug("hs_video_setting() E\n");
  table_write_cmos_sensor(addr_data_pair_hs_video_s5k4h7pd2166,
                          sizeof(addr_data_pair_hs_video_s5k4h7pd2166) / sizeof(kal_uint16));
}

static void slim_video_setting(void)
{
  pr_debug("slim_video_setting() E\n");
  table_write_cmos_sensor(addr_data_pair_slim_video_s5k4h7pd2166,
                          sizeof(addr_data_pair_slim_video_s5k4h7pd2166) / sizeof(kal_uint16));

}
static void custom1_setting(void)
{
	pr_debug("start \n");
	table_write_cmos_sensor(addr_data_pair_custom1_s5k4h7pd2166,
		   sizeof(addr_data_pair_custom1_s5k4h7pd2166) / sizeof(kal_uint16));
	pr_debug("end \n");
}
...
{
	pr_debug("start \n");
	table_write_cmos_sensor(addr_data_pair_custom2_s5k4h7pd2166,
		   sizeof(addr_data_pair_custom2_s5k4h7pd2166) / sizeof(kal_uint16));
	pr_debug("end \n");
}
...
{
	pr_debug("start \n");
	table_write_cmos_sensor(addr_data_pair_custom3_s5k4h7pd2166,
		   sizeof(addr_data_pair_custom3_s5k4h7pd2166) / sizeof(kal_uint16));
	pr_debug("end \n");
}
...
{
	pr_debug("start \n");
	table_write_cmos_sensor(addr_data_pair_custom4_s5k4h7pd2166,
		   sizeof(addr_data_pair_custom4_s5k4h7pd2166) / sizeof(kal_uint16));
	pr_debug("end \n");
}
...
{
	pr_debug("start \n");
	table_write_cmos_sensor(addr_data_pair_custom5_s5k4h7pd2166,
		   sizeof(addr_data_pair_custom5_s5k4h7pd2166) / sizeof(kal_uint16));
	pr_debug("end \n");
}
...
static kal_uint32 get_imgsensor_id(UINT32 *sensor_id)
{
 ...
 //        if(0 == ctidFlag){
        ...
        pr_debug("add:start read eeprom  - when_power_on  = %d\n",vivo_sub_otp_read_when_power_on_s5k4h7pd2166);
        sensor_init();
        vivo_sub_otp_read_when_power_on_s5k4h7pd2166=S5K4H7PD2166_otp_read();
        pr_info("add:end read eeprom - when_power_on = %d\n",vivo_sub_otp_read_when_power_on_s5k4h7pd2166);
        pr_debug("read eeprom ---vivo_otp_read_when_power_on = %d,MAIN_F8D1_OTP_ERROR_CODE=%d\n", vivo_sub_otp_read_when_power_on_s5k4h7pd2166, S5K4H7PD2166_OTP_ERROR_CODE);
		//vivo hope add end
        pr_info("i2c write id: 0x%x, sensor id: 0x%x\n", imgsensor.i2c_write_id,*sensor_id);	  
        return ERROR_NONE;
			} else {
         ...
         *	pr_debug(
         *	"sp8Flag(0x%x),0x5003 used by s5k4h7pd2166\n", sp8spFlag);
         *
         *	if (sp8spFlag == 0x5003) {
         *		pr_debug("it is s5k4h7pd2166\n");
         *		return ERROR_NONE;
         *	}
         *
         *		pr_debug(
                                  ...
                                  UINT8 *feature_para, UINT32 *feature_para_len)
{
	...
	case SENSOR_FEATURE_GET_CUSTOM_INFO:
		...
		case 0:    //info type: otp state
			*(MUINT32 *)(uintptr_t)(*(feature_data+1)) = S5K4H7PD2166_OTP_ERROR_CODE;//otp_state
			memcpy(feature_data+2, sn_inf_sub_s5k4h7pd2166, sizeof(MUINT32)*13);
			memcpy( feature_data+10, material_inf_sub_s5k4h7pd2166, sizeof(MUINT32)*4); 
			break;
		}
		break;
#endif
...
UINT32 S5K4H7PD2166_MIPI_RAW_SensorInit(
