...
#endif
//PK_DBG("wl get imgsensor info wl!!!!\n");
			   ...
			   MSDK_SENSOR_CONFIG_STRUCT *sensor_config_data)
{
	...
	sensor_info->PDAF_Support = PDAF_SUPPORT_CAMSV;//PDAF_SUPPORT_CAMSV;
...
/*
    ...
    */
	...
	case SENSOR_FEATURE_GET_TEMPERATURE_VALUE:
		printk("MAIN_F8D1 feature_control SENSOR_FEATURE_GET_TEMPERATURE_VALUE powerstate =%d\n", powerstate);
		if (powerstate == 1) {
