...
static int  isJN1OrJNV      = 0; //default:0 JN1:1 JNV:2
static int  isOtpSetting    = 0; //default:0 otp setting:1 no-otp:2

static struct imgsensor_info_struct imgsensor_info = {
	.sensor_id = S5KJN1SQ03PD2163_SENSOR_ID,
...
static struct SET_PD_BLOCK_INFO_T imgsensor_pd_info =  //4080X3072
{
	...
	.i4BlockNumY = 382,
	.iMirrorFlip = 3,
	.i4Crop = { {0,0}, {0,0}, {0, 382}, {0, 0}, {0, 0}, {0, 0}, {120, 450}, {0, 0}, {0, 0}, {120, 450}}, //4080, 2296
};
#endif
...
MUINT32  af_calib_inf_main_s5kjn1sq03pd2163[6];
MUINT32  crosstalk_data_PD2163[8006];  /*0 flag   1-836 data*/
...
static void sensor_init(void)
{
	...
	if (1 == isJN1OrJNV) {
		...
		PK_DBG("sensor_init JN1 \n");
	}
	else if (2 == isJN1OrJNV) {
		write_cmos_sensor_16_16(0x0000,0x38EF);
		PK_DBG("sensor_init JNV \n");
	}
	write_cmos_sensor_16_16(0x0000,0x38E1);
	...
	while (imgsensor_info.i2c_addr_table[i] != 0xff) {
		...
		do {
			*sensor_id = read_cmos_sensor_16_16(0x0000);
			...
			if ((0x38e1 == *sensor_id) || (0xe138 == *sensor_id)) {
				isJN1OrJNV = 1;
			}
			else if (0x38ef == *sensor_id) {
				isJN1OrJNV = 2;
			}
				  ...
				  UINT8 *feature_para, UINT32 *feature_para_len)
{
	...
	case SENSOR_FEATURE_GET_OFFSET_TO_START_OF_EXPOSURE:
		*(MUINT32 *)(uintptr_t)(*(feature_data + 1)) = 2150000;
		break;
    ...
    */
		...
		switch (*feature_data) {
			...
			if (*feature_para_len >= sizeof(MUINT32)*13 + 2) {
			    *(MUINT32 *)(uintptr_t)((feature_data+1)) = S5KJN1SQ03_OTP_ERROR_CODE;//otp_state
				...
				memcpy( feature_data+12, af_calib_inf_main_s5kjn1sq03pd2163, sizeof(MUINT32)*6);
				#if 0
						for (i = 0 ; i<12 ; i++ ){
	...
	case SENSOR_FEATURE_GET_4CELL_DATA:/*get 4 cell data from eeprom*/
	{
		...
		if (type == FOUR_CELL_CAL_TYPE_XTALK_CAL) {
			...
			data[1] = 0x1F;
			for(i = 0; i< 8006 ; i++)
			data[2 + i] = crosstalk_data_PD2163[i];
...
UINT32 S5KJN1SQ03PD2163_MIPI_RAW_SensorInit(
