 ...
 * Filename:
 * ---------
 *	 s5kjn1sq03pd2167fmipiraw_Sensor.c
 *
 * Project:
 * --------
 *	 ALPS
...
#include "s5kjn1sq03pd2167fmipiraw_freq.h"
...
static struct imgsensor_info_struct imgsensor_info = {
	.sensor_id = S5KJN1SQ03PD2167F_SENSOR_ID,
...
extern otp_error_code_t S5KJN1SQ03PD2167F_OTP_ERROR_CODE;
#endif
MUINT32  sn_inf_main_s5kjn1sq03pd2167f[13];  /*0 flag   1-12 data*/
MUINT32  material_inf_main_s5kjn1sq03pd2167f[4];
MUINT32  af_calib_inf_main_s5kjn1sq03pd2167f[6];
MUINT32  crosstalk_data_s5kjn1sq03pd2167f[8006];  /*0 flag   1-836 data*/
	...
	while (imgsensor_info.i2c_addr_table[i] != 0xff) {
		...
		do {
			*sensor_id = read_cmos_sensor_16_16(0x0000);
			...
			if (( *sensor_id == imgsensor_info.sensor_id) || ( *sensor_id == 0xe138)) { //compatible jnv\jn1
...
static kal_uint32 open(void)
{
	...
	if ((imgsensor_info.sensor_id != sensor_id) && (sensor_id != 0xe138)) //compatible jnv\jn1
		return ERROR_SENSOR_CONNECT_FAIL;
...
#ifdef HOPE_ADD_FOR_CAM_TEMPERATURE_NODE  //add for s5kjn1sq03pd2167f temperature
static kal_uint32 get_sensor_temperature(void)
{
	...
	if (TMC_Shift_Value > 0x7FFF ){
		...
		if (TMC_Value > 100){
			PK_DBG("s5kjn1sq03 TMC 0X000A temperature Value=%d, cause of TMC > 100 \n", TMC_Value);
			TMC_Value = 0;
		}
		sensor_temperature[0] = TMC_Value;

		if (__ratelimit(&ratelimit))
			PK_DBG("s5kjn1sq03 TMC 0X000A temperature Value=0x%x, sensor_temperature[0] =%d\n", TMC_Value, sensor_temperature[0]);
	}
    ...
    */
	...
	case SENSOR_FEATURE_GET_CUSTOM_INFO:
		...
		switch (*feature_data) {
			...
			if (*feature_para_len >= sizeof(MUINT32)*13 + 2) {
				*(MUINT32 *)(uintptr_t)(*(feature_data+1)) = S5KJN1SQ03PD2167F_OTP_ERROR_CODE;//otp_state
				memcpy( feature_data+2, sn_inf_main_s5kjn1sq03pd2167f, sizeof(MUINT32)*13);
				memcpy( feature_data+10, material_inf_main_s5kjn1sq03pd2167f, sizeof(MUINT32)*4);
				memcpy( feature_data+12, af_calib_inf_main_s5kjn1sq03pd2167f, sizeof(MUINT32)*6);
			#if 0
				for (i = 0 ; i<12 ; i++ ){
					printk("sn_inf_main_s5kjn1sq03pd2167f[%d]= 0x%x\n", i, sn_inf_main_s5kjn1sq03pd2167f[i]);
				}
			#endif
			}
				break;
	...
	case SENSOR_FEATURE_GET_4CELL_DATA:/* get 4 cell data from eeprom*/
	{
		...
		if (type == FOUR_CELL_CAL_TYPE_XTALK_CAL) {
			...
			data[1] = 0x1F;
			for(i = 0; i< 8006 ; i++)
				data[2 + i] = crosstalk_data_s5kjn1sq03pd2167f[i];
...
UINT32 S5KJN1SQ03PD2167F_MIPI_RAW_SensorInit(
