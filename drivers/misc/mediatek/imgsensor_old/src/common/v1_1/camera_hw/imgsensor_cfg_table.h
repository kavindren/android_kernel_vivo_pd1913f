...
enum IMGSENSOR_HW_PIN {
	...
	IMGSENSOR_HW_PIN_AVDD_1P8,
	IMGSENSOR_HW_PIN_OISVDD,
#if defined(CONFIG_MTK_CAM_PD2135)
	IMGSENSOR_HW_PIN_OISVDD_DEPENDENCY,
#else
	IMGSENSOR_HW_PIN_OISVM,
#endif
#ifdef CONFIG_REGULATOR_FAN53870 //for fan53870 and so on
	IMGSENSOR_HW_PIN_PLUGIC_EN,//7
#endif
#ifdef CONFIG_REGULATOR_RT5133
	IMGSENSOR_HW_PIN_AVDD1,
#endif
    IMGSENSOR_HW_PIN_AFVDD,//8
	IMGSENSOR_HW_PIN_DVDD,//9
...
enum IMGSENSOR_HW_PIN_STATE {
	...
	IMGSENSOR_HW_PIN_STATE_LEVEL_1180,
	...
	IMGSENSOR_HW_PIN_STATE_LEVEL_3100,
...
#define OISMCLK  	IMGSENSOR_HW_PIN_MCLK_OIS
#define PDN         IMGSENSOR_HW_PIN_PDN
#define RST         IMGSENSOR_HW_PIN_RST
#define OISRST      IMGSENSOR_HW_PIN_RST_OIS
#define AVDD        IMGSENSOR_HW_PIN_AVDD
#define AVDD_1P8    IMGSENSOR_HW_PIN_AVDD_1P8
#define OISVDD      IMGSENSOR_HW_PIN_OISVDD
#define OISVM      IMGSENSOR_HW_PIN_OISVM
...
#endif
#if defined(CONFIG_MTK_CAM_PD2135)
#define OISVDD_DEPENDENCY      IMGSENSOR_HW_PIN_OISVDD_DEPENDENCY	/*vivo hope add for ois listening mode 2021.5.20*/
#endif
#define DVDD        IMGSENSOR_HW_PIN_DVDD
#define DOVDD       IMGSENSOR_HW_PIN_DOVDD
#define VDD_None    IMGSENSOR_HW_PIN_NONE
#define AFVDD_DEF    IMGSENSOR_HW_PIN_AFVDD// vivo 
#ifdef CONFIG_REGULATOR_FAN53870
#define PLUGIC_EN IMGSENSOR_HW_PIN_PLUGIC_EN
#endif
...
#define Vol_1180  IMGSENSOR_HW_PIN_STATE_LEVEL_1180
...
#define Vol_3100  IMGSENSOR_HW_PIN_STATE_LEVEL_3100
