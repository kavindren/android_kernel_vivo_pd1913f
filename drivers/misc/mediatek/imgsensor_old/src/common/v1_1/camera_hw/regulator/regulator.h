...
enum REGULATOR_VOLTAGE {
	...
	REGULATOR_VOLTAGE_1180 = 1180000,
	...
	REGULATOR_VOLTAGE_3100 = 3100000,
};

enum REGULATOR_TYPE {
	REGULATOR_TYPE_VCAMA,
	REGULATOR_TYPE_VCAMA_1P8,
	REGULATOR_TYPE_VCAMOIS,
#if defined(CONFIG_MTK_CAM_PD2135)
	REGULATOR_TYPE_VCAMOIS_DEPENDENCY,	/*vivo hope add for ois listening mode 2021.5.20*/
#else
	REGULATOR_TYPE_VMOIS,
#endif
