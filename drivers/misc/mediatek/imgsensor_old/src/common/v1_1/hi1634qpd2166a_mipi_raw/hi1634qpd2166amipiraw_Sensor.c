...
static struct imgsensor_info_struct imgsensor_info = {
	.sensor_id = HI1634QPD2166A_SENSOR_ID,
...
extern otp_error_code_t MAIN3_OTP_ERROR_CODE_HI1634QPD2166A;
MUINT32  sn_inf_main2_hi1634qpd2166a[13];
MUINT32  material_inf_main_hi1634qpd2166a[4];
...
static struct SENSOR_WINSIZE_INFO_STRUCT imgsensor_winsize_info[10] = {
	{ 4704, 3512,	0,	 0, 4704, 3512,  2352, 1756,  12,  2, 2320, 1740, 0, 0, 2320, 1740}, 	// preview (2320 x 1740)0
	{ 4704, 3512,	0,	 0, 4704, 3512,  4704, 3512,  24,  4, 4640, 3480, 0, 0, 4640, 3480}, 	// capture (4640 x 3496)1
	{ 4704, 3512,	0,	 0, 4704, 3512,  2352, 1756,  12,  2, 2320, 1312, 0, 0, 2320, 1312}, 	// video (2320 x 1312)2
	{ 4704, 3512,	0, 482, 4704, 2548,  2352, 1274,  536, 277,	1280,  720, 0, 0, 1280,  720}, 	// hs video (1280 x 720)3
	{ 4704, 3512,	0, 672, 4704, 2168,  2352, 1084,  216,  2,	1160, 872, 0, 0, 1160, 872}, 	// slim video (1160 x 872)4
	{ 4704, 3512,	0, 672, 4704, 2168,  2352, 1084,  216,  2,	1160, 872, 0, 0, 1160, 872}, 	// custom1 (1160 x 872)5
	{ 4704, 3512,	0, 672, 4704, 2168,  2352, 1084,  216,  2,	1160, 872, 0, 0, 1160, 872}, 	// custom2 (1160 x 872)6
	{ 4704, 3512,	0, 672, 4704, 2168,  2352, 1084,  216,  2,	1160, 872, 0, 0, 1160, 872}, 	// custom3 (1160 x 872)7
	{ 4704, 3512,	0,	 0, 4704, 3512,  2352, 1756,  12,  2, 2320, 1740, 0, 0, 2320, 1740}, 	// custom4 (2320 x 1740)0
	{ 4704, 3512,	0,	 0, 4704, 3512,  2352, 1756,  12,  2, 2320, 1740, 0, 0, 2320, 1740}, 	// custom5 (2320 x 1740)9
};
...
static kal_uint16 hi1634q_custom4_setting[] = {
	/*
	DISP_WIDTH = 2320
	DISP_HEIGHT = 1740
	DISP_NOTE = "QUAD_2SUM"
...
static kal_uint16 hi1634q_custom5_setting[] = {
	/*
	DISP_WIDTH = 2320
	DISP_HEIGHT = 1740
	DISP_NOTE = "QUAD_2SUM"
...
static void custom3_setting(void)
{
	...
	pr_debug("Hi-1634Q custom3 end\n");
}

static void custom4_setting(void)
{
	pr_debug("Hi-1634Q custom4_setting start\n");

	hi1634q_table_write_cmos_sensor(hi1634q_custom4_setting,
		sizeof(hi1634q_custom4_setting)/sizeof(kal_uint16));

	pr_debug("Hi-1634Q custom4 end\n");
}

static void custom5_setting(void)
{
	pr_debug("Hi-1634Q custom5_setting start\n");

	hi1634q_table_write_cmos_sensor(hi1634q_custom5_setting,
		sizeof(hi1634q_custom5_setting)/sizeof(kal_uint16));

	pr_debug("Hi-1634Q custom5_setting end\n");
		...
		do {
			*sensor_id = return_sensor_id()+1;
			if (*sensor_id == imgsensor_info.sensor_id) {
				...
				vivo_otp_read_when_power_on = vivo_main3_otp_read();
				 ...
				 UINT8 *feature_para, UINT32 *feature_para_len)
{
	...
	case SENSOR_FEATURE_GET_CUSTOM_INFO:
	    printk("SENSOR_FEATURE_GET_CUSTOM_INFO information type:%lld  MAIN3_1634_OTP_ERROR_CODE:%d \n", *feature_data,MAIN3_OTP_ERROR_CODE_HI1634QPD2166A);
		switch (*feature_data) {
			...
			if (*feature_para_len >= sizeof(MUINT32)*13 + 2) {
			    *(MUINT32 *)(uintptr_t)(*(feature_data+1)) = MAIN3_OTP_ERROR_CODE_HI1634QPD2166A;//otp_state
				memcpy( feature_data+2, sn_inf_main2_hi1634qpd2166a, sizeof(MUINT32)*13); 
				memcpy( feature_data+10, material_inf_main_hi1634qpd2166a, sizeof(MUINT32)*4); 
			#if 0
						for (i = 0 ; i<12 ; i++ ){
...
UINT32 HI1634QPD2166A_MIPI_RAW_SensorInit(struct SENSOR_FUNCTION_STRUCT **pfFunc)
{
