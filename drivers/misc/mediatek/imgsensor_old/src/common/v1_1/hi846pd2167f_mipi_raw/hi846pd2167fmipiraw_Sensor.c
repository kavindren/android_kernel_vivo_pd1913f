...
static struct imgsensor_info_struct imgsensor_info = {
	.sensor_id = HI846PD2167F_SENSOR_ID,
	.checksum_value = 0x55e2a82f,
	.pre = {
	    .pclk = 287730000,				//record different mode's pclk
...
extern otp_error_code_t SUB2_OTP_ERROR_CODE_HI846PD2167F;
#endif
MUINT32  sn_inf_sub2_hi846pd2167f[13];  /*0 flag   1-12 data*/
MUINT32  material_inf_sub2_hi846pd2167f[4];
			...
			do {
				*sensor_id = return_sensor_id();
				if (*sensor_id == imgsensor_info.sensor_id) {				
					...
					PK_DBG("cfx_add:end read eeprom ---vivo_sub2_otp_read_when_power_on = %d,SUB2_OTP_ERROR_CODE_HI846PD2167F =%d\n", vivo_sub2_otp_read_when_power_on,SUB2_OTP_ERROR_CODE_HI846PD2167F);
					/*vivo caofeixiang add end*/
					return ERROR_NONE;
				}	
				  ...
				  UINT8 *feature_para, UINT32 *feature_para_len)
{
	...
	(struct SENSOR_WINSIZE_INFO_STRUCT *) (uintptr_t) (*(feature_data + 1));
        ...
        case SENSOR_FEATURE_GET_CUSTOM_INFO:
		    PK_DBG("SENSOR_FEATURE_GET_CUSTOM_INFO information type:%lld  SUB2_OTP_ERROR_CODE_HI846PD2167F:%d \n", *feature_data,SUB2_OTP_ERROR_CODE_HI846PD2167F);
			switch (*feature_data) {
				...
				if (*feature_para_len >= sizeof(MUINT32)*13 + 2) {
				    *(MUINT32 *)(uintptr_t)(*(feature_data+1)) = SUB2_OTP_ERROR_CODE_HI846PD2167F;//otp_state
					memcpy( feature_data+2, sn_inf_sub2_hi846pd2167f, sizeof(MUINT32)*13); 
				    memcpy( feature_data+10, material_inf_sub2_hi846pd2167f, sizeof(MUINT32)*4); 
					#if 0
							for (i = 0 ; i<12 ; i++ ){
							printk("sn_inf_sub2_hi846pd2167f[%d]= 0x%x\n", i, sn_inf_sub2_hi846pd2167f[i]);
							}
...
UINT32 HI846PD2167F_MIPI_RAW_SensorInit(
