...
#include "imx766pd2133mipiraw_Sensor.h"
#include "imx766pd2133_eeprom.h"
/*chenhan add for ois*/
...
#define PFX "IMX766PD2133_camera_sensor"
/****************************   Modify end	**************************/
#define LOG_INF(format, args...) pr_err(PFX "[%s] " format, __func__, ##args)


static kal_uint8 qsc_flag;
BYTE imx766pd2133_LRC_data[352] = {0};

static DEFINE_SPINLOCK(imgsensor_drv_lock);
static struct mutex ois_lock;

static struct imgsensor_info_struct imgsensor_info = {
	.sensor_id = IMX766PD2133_SENSOR_ID,

	.checksum_value = 0x8ac2d94a,

	.pre = {	/* reg_I 3712x2784@30fps, w/ PDAF(HVBin)*/
		.pclk = 1409200000,		 
		.linelength = 15616,
		.framelength = 3008,
		.startx = 0,
	...
	.normal_video = {/*reg_J-1 3712x2088@30fps, w/ PDAF(HVBin)*/
		.pclk = 2152800000,
		.linelength = 31232,
		.framelength = 2296,
		.startx = 0,
	...
	.custom1 = {/* reg_I 3712x2784@30fps, w/ PDAF(HVBin)*/
		.pclk = 3504800000,
		.linelength = 15616,
		.framelength = 7480,
		.startx = 0,
		...
		.mipi_data_lp2hs_settle_dc = 85,
		/* following for GetDefaultFramerateByScenario() */
		.mipi_pixel_rate = 1705600000,//226290000,
		.max_framerate = 300, /* 30fps */
		.cit_min_value = 2, /*shutter min value*/
		.cit_step_value = 2, /*shutter step value*/
	...
	.custom2 = { /* reg_J-1 Video 60fps  HVBin*/
		.pclk = 2298400000,
		.linelength = 15616,
		.framelength = 2452,
		.startx = 0,
		.starty = 0,
		.grabwindow_width = 3712,
		.grabwindow_height = 2088, /*1746*/
		.mipi_data_lp2hs_settle_dc = 85,
		/* following for GetDefaultFramerateByScenario() */
		.mipi_pixel_rate = 876570000,//226290000,
		.max_framerate = 600, /* 30fps */
		.cit_min_value = 2, /*shutter min value*/
		.cit_step_value = 2, /*shutter step value*/
	},
	.custom3 = { /*reg_J-1 Video 60fps  VBin*/
		.pclk = 2298400000,		 
		.linelength = 15616,
		.framelength = 2452,
		.startx = 0,
	...
	.custom4 = { /*reg_I-1 Video 60fps, w/ PDAF(HVBin) SuperEis 2*/
		.pclk = 3016000000,		 
		.linelength = 15616,
		.framelength = 3218,
		.startx = 0,
		...
		.mipi_data_lp2hs_settle_dc = 85,
		/* following for GetDefaultFramerateByScenario() */
		.mipi_pixel_rate = 1262860000,//226290000,
		.max_framerate = 600, /* 30fps */
		.cit_min_value = 2, /*shutter min value*/
		.cit_step_value = 2, /*shutter step value*/
	},
	.custom5 = { /* reg k 7424x5568@24fps, PDAF*/
		.pclk = 1284400000,
		.linelength = 11552,
		.framelength = 7412,
		.startx = 0,
		.starty = 0,
		.grabwindow_width = 7424,
		.grabwindow_height = 5568,
		.mipi_data_lp2hs_settle_dc = 85,
		.mipi_pixel_rate = 930060000,
		.max_framerate = 150,
	...
	.custom6 = {	/* reg_M-HV 2160x1620@30fps w/ PDAF(HVbin) Dual Slave*/
		...
		.startx = 0,
		.starty = 0,
		.grabwindow_width = 2160,
		.grabwindow_height = 1620, /*1746*/
		.mipi_data_lp2hs_settle_dc = 85,
		/* following for GetDefaultFramerateByScenario() */
	...
	.custom7 = { /*reg_J-1 Video 60fps, w/ PDAF(HVBin)*/
		.pclk = 2298400000,		 
		.linelength = 15616,
		.framelength = 2452,
		.startx = 0,
	...
	.custom9 = {  /*  F2-DOL, F-DOL 1ST*/
		...
		.starty = 0,
		.grabwindow_width = 3712,
		.grabwindow_height = 2784,
		.mipi_data_lp2hs_settle_dc = 85,
		.mipi_pixel_rate = 1378740000,
		.max_framerate = 300,
		.cit_min_value = 2, /*shutter min value*/
		.cit_step_value = 2, /*shutter step value*/
	},
	.custom10 = {/* F2-DOL, F-DOL 1ST*/
		.pclk = 2152800000,
		.linelength = 15616,
		.framelength = 4592,
		.startx = 0,
...
static struct SENSOR_WINSIZE_INFO_STRUCT imgsensor_winsize_info[15] = {
	...
	{7424, 5568, 0,    0,    7424, 5568, 3712, 2784, 0,   0,   3712, 2784,  0,  0, 3712, 2784}, /* Preview HVBin*/
	{7424, 5568, 0,    0,    7424, 5568, 3712, 2784, 0,   0,   3712, 2784,  0,  0, 3712, 2784}, /* capture HVBin*/
	{7424, 5568, 0,    696,    7424, 4176, 3712, 2088, 0,   0,   3712, 2088,  0,  0, 3712, 2088}, /* normal video HVBin*/
	{7424, 5568, 1792,    1704,    3840, 2160, 1920, 1080, 0,   0,   1920, 1080,  0,  0, 1920, 1080}, /* hs_video HVBin*/
	{7424, 5568, 1792,    1704,    3840, 2160, 1920, 1080, 0,   0,   1920, 1080,  0,  0, 1920, 1080}, /* slim video HVBin*/
	{7424, 5568, 0,    0,    7424, 5568, 3712, 2784, 0,   0,   3712, 2784,  0,  0, 3712, 2784},//custom1 HVBin
	{7424, 5568, 0,    696,    7424, 4176, 3712, 2088, 0,   0,   3712, 2088,  0,  0, 3712, 2088}, /* custom2 VBin*/
	{7424, 5568, 0,    696,    7424, 4176, 3712, 2088, 0,   0,   3712, 2088,  0,  0, 3712, 2088}, /* custom3 VBin*/
	{7424, 5568, 0,    0,    7424, 5568, 3712, 2784, 0,   0,   3712, 2784,  0,  0, 3712, 2784}, /* custom4 HVBin*/	
	{7424, 5568, 0,    0,    7424, 5568, 7424, 5568, 0,   0,   7424, 5568,  0,  0, 7424, 5568}, /* custom5 HVBin*/
	{7424, 5568, 1552, 1164,    4320, 3240, 2160, 1620,  0,   0,   2160, 1620,  0,  0, 2160, 1620}, /* custom6 HVBin*/
	{7424, 5568, 0,    696,    7424, 4176, 3712, 2088, 0,   0,   3712, 2088,  0,  0, 3712, 2088}, /* custom7 HVBin*/
	{7424, 5568, 0,    696,    7424, 4176, 3712, 2088, 0,   0,   3712, 2088,  0,  0, 3712, 2088}, /* normal video 3.1 GHVBin*/
	{7424, 5568, 0,    0,    7424, 5568, 3712, 2784, 0,   0,   3712, 2784,  0,  0, 3712, 2784}, /* custom9 HVBin*/
	{7424, 5568, 0,    696,    7424, 4176, 3712, 2088, 0,   0,   3712, 2088,  0,  0, 3712, 2088}, /* custom10 HVBin*/
...
static struct SET_PD_BLOCK_INFO_T imgsensor_pd_info = {
    ...
    .i4LeFirst = 0,
    .i4Crop = {
        {0, 0}, {0, 0}, {128, 456}, {64, 228}, {64, 228},
        {0, 0}, {128, 456}, {128, 456},  {0, 0}, {0, 0}, {968, 726}, {0, 384} ,{0, 384}, {0, 0}, {0, 384}, 
    },  //{0, 1632}
    .iMirrorFlip = 3,
};
...
static struct SENSOR_VC_INFO2_STRUCT SENSOR_VC_INFO2[15] = {
	{
		0x03, 0x0a, 0x00, 0x08, 0x40, 0x00,//preview hvbin ok
		{
			{VC_STAGGER_NE, 0x00, 0x2b, 0xE80, 0x0AE0},
            {VC_PDAF_STATS_NE_PIX_1, 0x00, 0x30, 0x910, 0x2B8},
            {VC_PDAF_STATS_NE_PIX_2, 0x00, 0x31, 0x910, 0x2B8},
		},
		1
	},
	{
		0x01, 0x0a, 0x00, 0x08, 0x40, 0x00,//capture hvbin ok
		{
			{VC_STAGGER_NE, 0x00, 0x2b, 0xE80, 0x0AE0},
//            {VC_PDAF_STATS_NE_PIX_1, 0x00, 0x30, 0x910, 0x2B8},
//            {VC_PDAF_STATS_NE_PIX_2, 0x00, 0x31, 0x910, 0x2B8},
	...
	{
		0x03, 0x0a, 0x00, 0x08, 0x40, 0x00,//custom1 hvbin ok
		{
			{VC_STAGGER_NE, 0x00, 0x2b, 0xE80, 0x0AE0},
            {VC_PDAF_STATS_NE_PIX_1, 0x00, 0x30, 0x910, 0x2B8},
            {VC_PDAF_STATS_NE_PIX_2, 0x00, 0x31, 0x910, 0x2B8},
	...
	},
	{
	...
	},
 	{
		...
		{
			{VC_STAGGER_NE, 0x00, 0x2b, 0x1D00, 0x15C0},
	...
	},
 	{
		...
		{
			{VC_STAGGER_NE, 0x00, 0x2b, 0x0870, 0x0654},
            {VC_PDAF_STATS_NE_PIX_1, 0x00, 0x30, 0x546, 0x195},
            {VC_PDAF_STATS_NE_PIX_2, 0x00, 0x31, 0x546, 0x195},			
		},
		1
	},
 	{
	...
	{
		0x06, 0x0a, 0x00, 0x08, 0x40, 0x00,//HVBin custom9 3712x2784 2Exp 
		{
			{VC_STAGGER_NE, 0x00, 0x2b, 0x0E80, 0x0AE0},
			{VC_STAGGER_SE, 0x01, 0x2b, 0x0E80, 0x0AE0},		
 			{VC_PDAF_STATS_NE_PIX_1, 0x00, 0x30, 0x910, 0x2B8},
 			{VC_PDAF_STATS_NE_PIX_2, 0x00, 0x31, 0x910, 0x2B8},
 			{VC_PDAF_STATS_SE_PIX_1, 0x01, 0x30, 0x910, 0x2B8},
			{VC_PDAF_STATS_SE_PIX_2, 0x01, 0x31, 0x910, 0x2B8},
		},
		1
	},	
	{
		0x06, 0x0a, 0x00, 0x08, 0x40, 0x00,//HVBin custom10 3712x2088 2Exp 
		{
			{VC_STAGGER_NE, 0x00, 0x2b, 0x0E80, 0x0828},
			{VC_STAGGER_SE, 0x02, 0x2b, 0x0E80, 0x0828},		
 			{VC_PDAF_STATS_NE_PIX_1, 0x00, 0x30, 0x910, 0x20A},
 			{VC_PDAF_STATS_NE_PIX_2, 0x00, 0x31, 0x910, 0x20A},
 			{VC_PDAF_STATS_SE_PIX_1, 0x01, 0x30, 0x910, 0x20A},
			{VC_PDAF_STATS_SE_PIX_2, 0x01, 0x31, 0x910, 0x20A},
		},
		1
	},
};
...
extern int MAIN_766_otp_read(void);
extern otp_error_code_t IMX766PD2133_OTP_ERROR_CODE;
MUINT32  sn_inf_main_imx766pd2133[13];  /*0 flag   1-12 data*/
MUINT32  material_inf_main_imx766pd2133[4];
MUINT32  af_calib_inf_main_imx766pd2133[6];
extern u32 sensor_temperature[10];

static u8 imx766pd2133_QSC_setting[3072];
...
static kal_uint16 imx766pd2133_table_write_cmos_sensor(kal_uint16 *para, kal_uint32 len)
{
...
static kal_uint16 imx766pd2133_table_write_cmos_sensor(kal_uint16 *para,
						 kal_uint32 len)
{
	char puSendCmd[I2C_BUFFER_LEN];
	kal_uint32 tosend, IDX;
...
static void imx766pd2133_get_pdaf_reg_setting(MUINT32 regNum, kal_uint16 *regDa)
{
	int i, idx;
...
static void imx766pd2133_set_pdaf_reg_setting(MUINT32 regNum, kal_uint16 *regDa)
{
	imx766pd2133_table_write_cmos_sensor(regDa, regNum*2);
}
...
static kal_uint16 imx766pd2133_init_setting[] = {
	0x0136,	0x1A,
	0x0137,	0x00,
	...
	0xdf10,0x1f,//vod
//	0xdf50,0x10,//impedance
};

static kal_uint16 imx766pd2133_capture_30_setting[] = {
	0x0112,	0x0A,
	0x0113,	0x0A,
	0x0114,	0x02,
	0x0342,	0x3D,
...
static kal_uint16 imx766pd2133_preview_setting[] = {
	0x0112,	0x0A,
	0x0113,	0x0A,
	0x0114,	0x02,
	0x0342,	0x3D,
...
static kal_uint16 imx766pd2133_custom1_setting[] = {
/*
3Lane
reg_MTK-14
3712x2784@30fps, w/ PDAF(HVBin),MIPI data rate = 2.487Gsps/Trio, for AP:MTK
H: 3712
V: 2784
*/
//MIPI output setting
...
static kal_uint16 imx766pd2133_normal_video_setting[] = {
	0x0112,	0x0A,
	0x0113,	0x0A,
	0x0114,	0x02,
	0x0342,	0x7A,
...
static kal_uint16 imx766pd2133_custom2_setting[] = {
	0x0112,	0x0A,
	0x0113,	0x0A,
	0x0114,	0x02,
	0x0342,	0x3D,
...
static kal_uint16 imx766pd2133_custom3_setting[] = {
	0x0112,	0x0A,
	0x0113,	0x0A,
	0x0114,	0x02,
	0x0342,	0x3D,
...
static kal_uint16 imx766pd2133_slim_video_setting[] = {
	0x0112,	0x0A,
	0x0113,	0x0A,
	0x0114,	0x02,
	0x0342,	0x22,
...
static kal_uint16 imx766pd2133_hs_video_setting[] = {
...
static kal_uint16 imx766pd2133_custom4_setting[] = {
	0x0112,	0x0A,
	0x0113,	0x0A,
	0x0114,	0x02,
	0x0342,	0x3D,
...
static kal_uint16 imx766pd2133_custom5_setting[] = {
0x0112,	0x0A,
0x0113,	0x0A,
0x0114,	0x02,
...
static kal_uint16 imx766pd2133_custom6_setting[] = {
	0x0112,	0x0A,
	0x0113,	0x0A,
	0x0114,	0x02,
	0x0342,	0x3D,
...
static kal_uint16 imx766pd2133_custom7_setting[] = {
	0x0112,	0x0A,
	0x0113,	0x0A,
	0x0114,	0x02,
	0x0342,	0x3D,
...
static kal_uint16 imx766pd2133_custom8_setting[] = {
	0x0112,	0x0A,
	0x0113,	0x0A,
	0x0114,	0x02,
...
static kal_uint16 imx766pd2133_custom9_setting[] = {
	0x0112,	0x0A,
	0x0113,	0x0A,
	0x0114,	0x02,
	0x0342,	0x3D,
...
static kal_uint16 imx766pd2133_custom10_setting[] = {
	0x0112,	0x0A,
	0x0113,	0x0A,
	0x0114,	0x02,
	0x0342,	0x3D,
	...
	kal_uint32 shutter_2ndframe, kal_uint32 gain_2ndframe)
{
	...
	case MSDK_SCENARIO_ID_CAMERA_PREVIEW:
	{
		...
		backup_gain_ms = imx766pd2133_preview_setting[78];
		backup_gain_ls = imx766pd2133_preview_setting[79];
		backup_exposure_ms = imx766pd2133_preview_setting[69];
		backup_exposure_ls = imx766pd2133_preview_setting[70];

		if (gain != 0) {
			imx766pd2133_preview_setting[78] = (gain >> 8) & 0xff;
			imx766pd2133_preview_setting[79] = gain & 0xff;
		}
		if (shutter != 0) {
			imx766pd2133_preview_setting[69] = (shutter >> 8) & 0xff;
			imx766pd2133_preview_setting[70] = shutter & 0xff;
		}

		write_cmos_sensor_8(0x0104, 0x01);
		imx766pd2133_table_write_cmos_sensor(imx766pd2133_preview_setting,
				sizeof(imx766pd2133_preview_setting) / sizeof(kal_uint16));
		write_cmos_sensor_8(0x0104, 0x00);

		imx766pd2133_preview_setting[78] = backup_gain_ms;
		imx766pd2133_preview_setting[79] = backup_gain_ls;
		imx766pd2133_preview_setting[69] = backup_exposure_ms;
		imx766pd2133_preview_setting[70] = backup_exposure_ls;
	}
		break;
	case MSDK_SCENARIO_ID_CUSTOM1:
	{
		...
		backup_gain_ms = imx766pd2133_custom1_setting[78];
		backup_gain_ls = imx766pd2133_custom1_setting[79];
		backup_exposure_ms = imx766pd2133_custom1_setting[69];
		backup_exposure_ls = imx766pd2133_custom1_setting[70];

		if (gain != 0) {
			imx766pd2133_custom1_setting[78] = (gain >> 8) & 0xff;
			imx766pd2133_custom1_setting[79] = gain & 0xff;
		}
		if (shutter != 0) {
			imx766pd2133_custom1_setting[69] = (shutter >> 8) & 0xff;
			imx766pd2133_custom1_setting[70] = shutter & 0xff;
		}

		write_cmos_sensor_8(0x0104, 0x01);
		imx766pd2133_table_write_cmos_sensor(imx766pd2133_custom1_setting,
				sizeof(imx766pd2133_custom1_setting) / sizeof(kal_uint16));
		write_cmos_sensor_8(0x0104, 0x00);

		imx766pd2133_custom1_setting[78] = backup_gain_ms;
		imx766pd2133_custom1_setting[79] = backup_gain_ls;
		imx766pd2133_custom1_setting[69] = backup_exposure_ms;
		imx766pd2133_custom1_setting[70] = backup_exposure_ls;
	}
		break;
	case MSDK_SCENARIO_ID_CUSTOM2:
	{
		...
		backup_gain_ms = imx766pd2133_custom2_setting[78];
		backup_gain_ls = imx766pd2133_custom2_setting[79];
		backup_exposure_ms = imx766pd2133_custom2_setting[69];
		backup_exposure_ls = imx766pd2133_custom2_setting[70];

		if (gain != 0) {
			imx766pd2133_custom2_setting[78] = (gain >> 8) & 0xff;
			imx766pd2133_custom2_setting[79] = gain & 0xff;
		}
		if (shutter != 0) {
			imx766pd2133_custom2_setting[69] = (shutter >> 8) & 0xff;
			imx766pd2133_custom2_setting[70] = shutter & 0xff;
		}

		write_cmos_sensor_8(0x0104, 0x01);
		imx766pd2133_table_write_cmos_sensor(imx766pd2133_custom2_setting,
				sizeof(imx766pd2133_custom2_setting) / sizeof(kal_uint16));
		write_cmos_sensor_8(0x0104, 0x00);

		imx766pd2133_custom2_setting[78] = backup_gain_ms;
		imx766pd2133_custom2_setting[79] = backup_gain_ls;
		imx766pd2133_custom2_setting[69] = backup_exposure_ms;
		imx766pd2133_custom2_setting[70] = backup_exposure_ls;
	}
		break;
	case MSDK_SCENARIO_ID_CUSTOM3:
	{
		...
		backup_gain_ms = imx766pd2133_custom3_setting[78];
		backup_gain_ls = imx766pd2133_custom3_setting[79];
		backup_exposure_ms = imx766pd2133_custom3_setting[69];
		backup_exposure_ls = imx766pd2133_custom3_setting[70];

		if (gain != 0) {
			imx766pd2133_custom3_setting[78] = (gain >> 8) & 0xff;
			imx766pd2133_custom3_setting[79] = gain & 0xff;
		}
		if (shutter != 0) {
			imx766pd2133_custom3_setting[69] = (shutter >> 8) & 0xff;
			imx766pd2133_custom3_setting[70] = shutter & 0xff;
		}
		write_cmos_sensor_8(0x0104, 0x01);
		imx766pd2133_table_write_cmos_sensor(imx766pd2133_custom3_setting,
				sizeof(imx766pd2133_custom3_setting) / sizeof(kal_uint16));
		write_cmos_sensor_8(0x0104, 0x00);

		imx766pd2133_custom3_setting[78] = backup_gain_ms;
		imx766pd2133_custom3_setting[79] = backup_gain_ls;
		imx766pd2133_custom3_setting[69] = backup_exposure_ms;
		imx766pd2133_custom3_setting[70] = backup_exposure_ls;
	}
		break;
	case MSDK_SCENARIO_ID_VIDEO_PREVIEW:
	{
		...
		backup_gain_ms = imx766pd2133_normal_video_setting[78];
		backup_gain_ls = imx766pd2133_normal_video_setting[79];
		backup_exposure_ms = imx766pd2133_normal_video_setting[69];
		backup_exposure_ls = imx766pd2133_normal_video_setting[70];

		if (gain != 0) {
			imx766pd2133_normal_video_setting[78] = (gain >> 8) & 0xff;
			imx766pd2133_normal_video_setting[79] = gain & 0xff;
		}
		if (shutter != 0) {
			imx766pd2133_normal_video_setting[69] = (shutter >> 8) & 0xff;
			imx766pd2133_normal_video_setting[70] = shutter & 0xff;
		}

		write_cmos_sensor_8(0x0104, 0x01);
		imx766pd2133_table_write_cmos_sensor(imx766pd2133_normal_video_setting,
				sizeof(imx766pd2133_normal_video_setting) / sizeof(kal_uint16));
		write_cmos_sensor_8(0x0104, 0x00);

		imx766pd2133_normal_video_setting[78] = backup_gain_ms;
		imx766pd2133_normal_video_setting[79] = backup_gain_ls;
		imx766pd2133_normal_video_setting[69] = backup_exposure_ms;
		imx766pd2133_normal_video_setting[70] = backup_exposure_ls;
	}
		break;
	default:
	{
...
{
	LOG_INF("E\n");
	imx766pd2133_table_write_cmos_sensor(imx766pd2133_init_setting,
		sizeof(imx766pd2133_init_setting)/sizeof(kal_uint16));
...
static void capture_setting(kal_uint16 currefps)
{
	...
	imx766pd2133_table_write_cmos_sensor(imx766pd2133_capture_30_setting,
		sizeof(imx766pd2133_capture_30_setting)/sizeof(kal_uint16));
...
static void slim_video_setting(void)
{
	...
	imx766pd2133_table_write_cmos_sensor(imx766pd2133_slim_video_setting,
		sizeof(imx766pd2133_slim_video_setting)/sizeof(kal_uint16));
}
static void hs_video_setting(void)
{
	LOG_INF("%s 1920x1080 120fps HVBin E\n", __func__);
	imx766pd2133_table_write_cmos_sensor(imx766pd2133_hs_video_setting,
		sizeof(imx766pd2133_hs_video_setting)/sizeof(kal_uint16));
}
...
static void custom4_setting(void)
{
	...
	imx766pd2133_table_write_cmos_sensor(imx766pd2133_custom4_setting,
		sizeof(imx766pd2133_custom4_setting)/sizeof(kal_uint16));
...
static void custom5_setting(void)
{
	...
	imx766pd2133_table_write_cmos_sensor(imx766pd2133_custom5_setting,
		sizeof(imx766pd2133_custom5_setting)/sizeof(kal_uint16));
...
static void custom6_setting(void)
{
	...
	imx766pd2133_table_write_cmos_sensor(imx766pd2133_custom6_setting,
		sizeof(imx766pd2133_custom6_setting)/sizeof(kal_uint16));
...
static void custom7_setting(void)
{
	...
	imx766pd2133_table_write_cmos_sensor(imx766pd2133_custom7_setting,
		sizeof(imx766pd2133_custom7_setting)/sizeof(kal_uint16));
...
{
	LOG_INF("%s Preview Mode 3712  2088 60fps\n", __func__);
	/*************MIPI output setting************/

	imx766pd2133_table_write_cmos_sensor(imx766pd2133_custom8_setting,
		sizeof(imx766pd2133_custom8_setting)/sizeof(kal_uint16));
...
static void custom9_setting(void)
{
	...
	imx766pd2133_table_write_cmos_sensor(imx766pd2133_custom9_setting,
		sizeof(imx766pd2133_custom9_setting)/sizeof(kal_uint16));
...
static void custom10_setting(void)
{
	...
	imx766pd2133_table_write_cmos_sensor(imx766pd2133_custom10_setting,
		sizeof(imx766pd2133_custom10_setting)/sizeof(kal_uint16));
...
static void read_sensor_Cali(void)
{
	...
	for (idx = 0; idx < 3072; idx++) {
		addr_qsc = 0x2442 + idx;
		imx766pd2133_QSC_setting[idx] = read_cmos_eeprom_8(addr_qsc);
	}
...
static void write_sensor_QSC(void)
{
	...
	is_sensor_write8_sequential(pi2c_cfg->pinst->pi2c_client,0xC800,imx766pd2133_QSC_setting,3072);
 ...
 *
 * DESCRIPTION
 *	chenhan add this function do acc ois create & init for multi-gyro solution
 *
 * PARAMETERS
 *
 * RETURNS
		...
		do {
			*sensor_id = ((read_cmos_sensor_8(0x0016) << 8)
			...
			if (*sensor_id == imgsensor_info.sensor_id) {
				...
				vivo_otp_read_when_power_on = MAIN_766_otp_read();
				read_sensor_Cali();
				return ERROR_NONE;
			}
...
static kal_uint32 imx766pd2133_awb_gain(struct SET_SENSOR_AWB_GAIN *pSetSensorAWB)
{
...
static kal_uint32 imx766pd2133_ana_gain_table[] = {
	100000,
	100098,
	100196,
	100294,
				 ...
				 UINT8 *feature_para, UINT32 *feature_para_len)
{
	...
	case SENSOR_FEATURE_GET_ANA_GAIN_TABLE:
		if ((void *)(uintptr_t) (*(feature_data + 1)) == NULL) {
			*(feature_data + 0) =
				sizeof(imx766pd2133_ana_gain_table);
		} else {
			memcpy((void *)(uintptr_t) (*(feature_data + 1)),
			(void *)imx766pd2133_ana_gain_table,
			sizeof(imx766pd2133_ana_gain_table));
		}
		break;
 ...
 */
	...
	case SENSOR_FEATURE_GET_PDAF_REG_SETTING:
		LOG_INF("SENSOR_FEATURE_GET_PDAF_REG_SETTING %d",
			(*feature_para_len));
		imx766pd2133_get_pdaf_reg_setting((*feature_para_len) / sizeof(UINT32)
					   , feature_data_16);
		break;
	case SENSOR_FEATURE_SET_PDAF_REG_SETTING:
		 ...
		 *	(*feature_para_len));
		 */
		imx766pd2133_set_pdaf_reg_setting((*feature_para_len) / sizeof(UINT32)
					   , feature_data_16);
		break;
	...
	case SENSOR_FEATURE_GET_CUSTOM_INFO:
		...
		switch (*feature_data) {
			...
			if (*feature_para_len >= sizeof(MUINT32)*13 + 2) {
			    *(MUINT32 *)(uintptr_t)(*(feature_data+1)) = IMX766PD2133_OTP_ERROR_CODE;//otp_state
				memcpy( feature_data+2, sn_inf_main_imx766pd2133, sizeof(MUINT32)*13); 
				memcpy( feature_data+10, material_inf_main_imx766pd2133, sizeof(MUINT32)*4); 
				memcpy( feature_data+12, af_calib_inf_main_imx766pd2133, sizeof(MUINT32)*6);
				#if 0
						for (i = 0 ; i<12 ; i++ ){
						printk("sn_inf_main_imx766pd2133[%d]= 0x%x\n", i, sn_inf_main_imx766pd2133[i]);
						}
				#endif
			}
				break;
	...
	case SENSOR_FEATURE_SET_AWB_GAIN:
		imx766pd2133_awb_gain(pSetSensorAWB);
		break;
#if 0
...
UINT32 IMX766PD2133_MIPI_RAW_SensorInit(struct SENSOR_FUNCTION_STRUCT **pfFunc)
{
	/* To Do : Check Sensor status here */
	if (pfFunc != NULL)
		*pfFunc = &sensor_func;
	return ERROR_NONE;
} /* IMX766PD2133_MIPI_RAW_SensorInit */
