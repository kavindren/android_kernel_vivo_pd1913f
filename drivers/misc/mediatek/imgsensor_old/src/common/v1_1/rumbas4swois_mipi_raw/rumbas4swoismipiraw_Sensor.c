 ...
 *============================================================================
 ****************************************************************************/
#define PFX "RUMBAS4SWOIS_camera_sensor"
...
#include "rumbas4swoismipiraw_Sensor.h"
...
static struct imgsensor_info_struct imgsensor_info = {
	.sensor_id = RUMBAS4SWOIS_SENSOR_ID,
...
static struct SENSOR_WINSIZE_INFO_STRUCT imgsensor_winsize_info[7] = {
 { 4160, 3120, 0,	0, 4160, 3120, 4160, 3120, 0, 0, 4160, 3120, 0, 0, 4160, 3120}, /* preview */
 { 4160, 3120, 0,	0, 4160, 3120, 4160, 3120, 0,	0, 4160, 3120, 0, 0, 4160, 3120}, /* capture */
 { 4160, 3120, 0,390, 4160, 2340, 4160, 2340, 0, 0, 4160, 2340, 0, 0, 4160, 2340},  /* video */
 #if 0
				 ...
				 UINT8 *feature_para, UINT32 *feature_para_len)
{
	...
	case SENSOR_FEATURE_GET_CUSTOM_INFO:
		pr_debug("SENSOR_FEATURE_GET_CUSTOM_INFO information type:%lld  RUMBAS4SWOIS_OTP_ERROR_CODE:%d \n", *feature_data,RUMBAS4SWOIS_OTP_ERROR_CODE);
			switch (*feature_data) {
				...
				if (*feature_para_len >= sizeof(MUINT32)*13 + 2) {
					*(MUINT32 *)(uintptr_t)(*(feature_data+1)) = RUMBAS4SWOIS_OTP_ERROR_CODE;//otp_state
					memcpy( feature_data+2, sn_inf_main_rumbas4swois, sizeof(MUINT32)*13); 
					#if 0
						for (i = 0 ; i<12 ; i++ ){
						printk("sn_inf_main_rumbas4swois[%d]= 0x%x\n", i, sn_inf_main_rumbas4swois[i]);
						}
...
UINT32 RUMBAS4SWOIS_MIPI_RAW_SensorInit(struct SENSOR_FUNCTION_STRUCT **pfFunc)
{
