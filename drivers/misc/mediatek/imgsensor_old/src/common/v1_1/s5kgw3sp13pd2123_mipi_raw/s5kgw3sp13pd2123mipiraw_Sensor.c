 ...
 * Filename:
 * ---------
 *	 s5kgw3sp13pd2123mipiraw_Sensor.c
 *
 * Project:
 * --------
 *	 ALPS
...
#include "s5kgw3sp13pd2123mipiraw_freq.h"
...
static struct imgsensor_info_struct imgsensor_info = {
	.sensor_id = S5KGW3SP13PD2123_SENSOR_ID,
...
extern int MAIN_7309_otp_read_gw3_pd2123(void);
extern otp_error_code_t S5KGW3SP13PD2123_OTP_ERROR_CODE;
MUINT32  sn_inf_main_s5kgw3sp13pd2123[13];  /*0 flag   1-12 data*/
MUINT32  material_inf_main_s5kgw3sp13pd2123[4];
MUINT32  af_calib_inf_main_s5kgw3sp13pd2123[6];
		...
		do {
			*sensor_id = read_cmos_sensor_16_16(0x0000) ;
			...
			if ( *sensor_id == imgsensor_info.sensor_id) {
				...
				vivo_otp_read_when_power_on = MAIN_7309_otp_read_gw3_pd2123();
				pr_debug("read eeprom ---vivo_otp_read_when_power_on = %d,MAIN_F8D1_OTP_ERROR_CODE=%d\n", vivo_otp_read_when_power_on, S5KGW3SP13PD2123_OTP_ERROR_CODE);
				/*vivo lxd add end*/
				return ERROR_NONE;
			}
...
#ifdef HOPE_ADD_FOR_CAM_TEMPERATURE_NODE  //add for s5kgw3sp13pd2123 temperature 
	...
	case SENSOR_FEATURE_GET_CUSTOM_INFO:
		...
		switch (*feature_data) {
			...
			if (*feature_para_len >= sizeof(MUINT32)*13 + 2) {
			    *(MUINT32 *)(uintptr_t)((feature_data+1)) = S5KGW3SP13PD2123_OTP_ERROR_CODE;//otp_state
				memcpy( feature_data+2, sn_inf_main_s5kgw3sp13pd2123, sizeof(MUINT32)*13); 
				memcpy( feature_data+10, material_inf_main_s5kgw3sp13pd2123, sizeof(MUINT32)*4); 
				memcpy( feature_data+12, af_calib_inf_main_s5kgw3sp13pd2123, sizeof(MUINT32)*6);
				#if 0
						for (i = 0 ; i<12 ; i++ ){
						PK_DBG("sn_inf_main_s5kgw3sp13pd2123[%d]= 0x%x\n", i, sn_inf_main_s5kgw3sp13pd2123[i]);
						}
				#endif
			}
				break;
...
UINT32 S5KGW3SP13PD2123_MIPI_RAW_SensorInit(
