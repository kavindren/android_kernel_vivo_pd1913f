...
#define PFX "MAIN[971]_camera_sensor"
...
static bool bIsFirstPreview = KAL_TRUE;

static struct imgsensor_info_struct imgsensor_info = {
	.sensor_id = S5KHM2SP03PD2163_SENSOR_ID,
	.checksum_value = 0x67b95889,

	.pre = {
		.pclk = 1599000000,
		.linelength = 8480, /////8480  16632
		.framelength = 6284, /////6284  3200
		.startx =0,
		.starty = 0,
		...
		.mipi_pixel_rate = 1043328000,  ////1043328000  818065000
		.max_framerate = 300,
	},
	.cap = {
		.pclk = 1599000000,
	...
	.custom2 = { /* 4K 60fps */
		...
		.mipi_data_lp2hs_settle_dc = 85,
		/*	 following for GetDefaultFramerateByScenario()	*/
		.mipi_pixel_rate = 818065000,
		.max_framerate = 600,
		},
	 .custom3 = { /* 4K 60fps for super eis */
		.pclk = 1599000000,
		.linelength = 10968,
		.framelength = 2426,
		.startx = 0,
	...
	.custom4 = { /* 4K 60fps for super eis or reserved */
		.pclk = 1599000000,
		.linelength = 10968,
		.framelength = 2426,
		.startx = 0,
	...
	.custom5 = {
		...
		.mipi_data_lp2hs_settle_dc = 85,
		/*	 following for GetDefaultFramerateByScenario()	*/
		.mipi_pixel_rate = 1381225000,
		.max_framerate = 100,
	},

    .custom6 = { /*4000 * 3000 @30 binning*/
		.pclk = 1599000000,
		.linelength = 8480, /////8480  16632
		.framelength = 6284, /////6284  3200
		.startx =0,
    ...
    .custom8 = { /*4000 * 3000 @30 roi setting*/
		.pclk = 1599000000,
		.linelength = 16632,
		.framelength = 3200,
		.startx =0,
...
static struct SENSOR_WINSIZE_INFO_STRUCT imgsensor_winsize_info[15] = {
	{ 12000, 9000,	0,	0,   12000, 9000, 4000,  3000, 0000, 0000, 4000,  3000,	  0,	0, 4000,  3000}, /*Preview*/
	{ 12000, 9000,	0,	0,   12000, 9000, 4000,  3000, 0000, 0000, 4000,  3000,	  0,	0, 4000,  3000}, /*capture binning*/
	{ 12000, 9000,	0,	1116,   12000, 6768, 4000,  2256, 0000, 0000, 4000,  2256,	  0,	0, 4000,  2256}, /*video*/
	{ 12000, 9000,	240, 1260, 11520, 6480, 1920,  1080, 0000, 0000, 1920,  1080,	  0,	0, 1920,  1080}, /*hight speed video 120fps*/
	{ 12000, 9000,	240, 1260, 11520, 6480, 1920,  1080, 0000, 0000, 1920,  1080,	  0,	0, 1920,  1080}, /*slim video  hs_video 240fps*/
	{ 12000, 9000,	0,	0,   12000, 9000, 4000,  3000, 0000, 0000, 4000,  3000,	  0,	0, 4000,  3000}, /*custom1 binning size*/
	{ 12000, 9000,	240,	1260,   11520, 6480, 3840,  2160, 0000, 0000, 3840,  2160,	  0,	0, 3840,  2160}, /*custom2*/
	{ 12000, 9000,	240,	1260,   11520, 6480, 3840,  2160, 0000, 0000, 3840,  2160,	  0,	0, 3840,  2160}, /* custom3 4k 60 fps */
	{ 12000, 9000,	240,	1260,   11520, 6480, 3840,  2160, 0000, 0000, 3840,  2160,	  0,	0, 3840,  2160}, /* custom4 4k 60 fps */
	{ 12000, 9000,	0,	0,   12000, 9000, 12000,  9000, 0000, 0000, 12000,  9000,	  0,	0, 12000,  9000}, /*custom 5 12000*9000@10fps*/
    { 12000, 9000,	0,	0,   12000, 9000, 4000,  3000, 0000, 0000, 4000,  3000,	  0,	0, 4000,  3000}, /*custom6 4000*3000@30fps*/
    { 12000, 9000,	0,	1116,   12000, 6768, 4000,  2256, 0000, 0000, 4000,  2256,	  0,	0, 4000,  2256}, /* custom7 4000*2256@60fps */
    { 12000, 9000,	4000,	3000,   4000, 3000, 4000,  3000, 0000, 0000, 4000,  3000,	  0,	0, 4000,  3000}, /*custom8 roi romasic*/
    { 12000, 9000,	0,	0,   12000, 9000, 4000,  3000, 0000, 0000, 4000,  3000,	  0,	0, 4000,  3000}, /*custom9 4000*3000@30fps*/
    { 12000, 9000,	0,	1116,   12000, 6768, 4000,  2256, 0000, 0000, 4000,  2256,	  0,	0, 4000,  2256}, /*custom10 4000*2256@30fps*/
};
...
static struct SET_PD_BLOCK_INFO_T imgsensor_pd_info =
{
    ...
    .i4SubBlkW = 8,
    .i4SubBlkH = 2,
    .i4PosL = {{18, 17},{22, 18},{20, 21},{16, 22} },
    .i4PosR = {{19, 17},{23, 18},{21, 21},{17, 22}  },
    .i4BlockNumX = 496,
    .i4BlockNumY = 371,
    .i4LeFirst = 0,
    .i4Crop = {
        {0, 0}, {0, 0}, {0, 372}, {0, 0}, {0, 0},
        {0, 0}, {80, 420}, {80, 420},{80, 420},{0, 0}, {0, 0},{0, 372}, {0, 0}, {0, 0},{0, 372}
    },
	.iMirrorFlip = 3,
};
...
static struct SET_PD_BLOCK_INFO_T imgsensor_4k_pd_info =
{
    .i4OffsetX = 16,
    .i4OffsetY = 16,
    .i4PitchX = 8,
...
static struct SET_PD_BLOCK_INFO_T imgsensor_roi_pd_info =
{
    .i4OffsetX = 16,
    .i4OffsetY = 16,
    .i4PitchX = 24,
    ...
    .i4SubBlkW = 12,
    .i4SubBlkH = 6,
    .i4PosL = {{16, 4},{16, 5},{28, 6},{28, 7},{22, 16},{22, 17},{10, 18},{10, 19} },
    .i4PosR = {{17, 4},{17, 5},{29, 6},{29, 7},{23, 16},{23, 17},{11, 18},{11, 19} },
    .i4BlockNumX = 166,
    .i4BlockNumY = 125,
    .i4LeFirst = 0,
    .i4Crop = {
...
///////// 2Bin pdaf information  1920 x 1080 mode
static struct SET_PD_BLOCK_INFO_T imgsensor_pd_2Bin_info =
{
    .i4OffsetX = 0,
    .i4OffsetY = 6,
    .i4PitchX = 4,
...
static struct SENSOR_VC_INFO_STRUCT SENSOR_VC_INFO[5] = {
	/* Preview mode setting */  ///4000x3000 1984X742
	{
	...
	/* Video mode setting */   ///4000x2256 30fps 1984X562
	{
		0x03, 0x0a, 0x00, 0x08, 0x40, 0x00,
		0x00, 0x2b, 0x1200, 0x0A20, 0x00, 0x00, 0x0280, 0x0001,
		0x01, 0x30, 0x09B0, 0x022A, 0x03, 0x00, 0x0000, 0x0000

	},

	/* Custom2 mode setting */   ///3840x2160 60fps 1920X538
	{
		0x03, 0x0a, 0x00, 0x08, 0x40, 0x00,
		0x00, 0x2b, 0x1200, 0x0A20, 0x00, 0x00, 0x0280, 0x0001,
		0x01, 0x30, 0x04B0, 0x0434, 0x03, 0x00, 0x0000, 0x0000

	},

	/* Slim video mode setting */   ///1920x1080 120fps 960X268
	{
		0x03, 0x0a, 0x00, 0x08, 0x40, 0x00,
		0x00, 0x2b, 0x1200, 0x0A20, 0x00, 0x00, 0x0280, 0x0001,
		0x01, 0x30, 0x04B0, 0x010C, 0x03, 0x00, 0x0000, 0x0000

	},

	/* roi mode setting */   ///4000*3000 30fps 664X500
	{
		0x03, 0x0a, 0x00, 0x08, 0x40, 0x00,
		0x00, 0x2b, 0x1200, 0x0A20, 0x00, 0x00, 0x0280, 0x0001,
		0x01, 0x30, 0x0340, 0x01F4, 0x03, 0x00, 0x0000, 0x0000
...
extern int s5khm2sp03_otp_read(void);
static int vivo_otp_read_when_power_on;
extern otp_error_code_t S5KHM2SP03_OTP_ERROR_CODE;
MUINT32  sn_inf_main_s5khm2sp03[13];  /*0 flag   1-12 data*/

MUINT32  material_inf_main_s5khm2sp03[4];
MUINT32  af_calib_inf_main_s5khm2sp03[6];
...
static kal_uint32 streaming_control(kal_bool enable)
{
	...
	if (enable) {
		...
		//write_cmos_sensor_16_16(0x6214, 0xE9E0);
		//write_cmos_sensor_16_16(0x6218, 0x0110);
...
static void write_shutter(kal_uint32 shutter)
{
	...
	if(shutter > 65530) {  //linetime=10160/960000000<< maxshutter=3023622-line=32s
    	...
    	long_shutter = shutter / 128 ; /////128 = 2^7
    	PK_DBG("enter long exposure mode long_shutter = %d, long_exposure_time =%ld ms\n", long_shutter, exposure_time);
...
static kal_uint16 set_gain(kal_uint16 gain)
{
	...
	if (gain < BASEGAIN || gain > 40 * BASEGAIN) {
	    PK_DBG("Error gain setting");

	    if (gain < BASEGAIN)
	        gain = BASEGAIN;
	    else if (gain > 40 * BASEGAIN)
	        gain = 40 * BASEGAIN;
	}
...
0x6F12, 0xF438,
0x602A, 0x2228,
0x6F12, 0x3FFE,  ///power noise 0x3F0A
0x6F12, 0x3FFE,  ///power noise 0x3F0A
0x602A, 0x2230,
0x6F12, 0x0000,
0x6F12, 0xF43A,
...
0x6028, 0x2002,
0x602A, 0x4540,
0x6F12, 0x0108,    ///// MIPI 0118
0x6F12, 0x0700,    ///// MIPI 0F00
0x602A, 0x455A,
0x6F12, 0x0909,
0x6F12, 0x0000,
0x6F12, 0x0909,
...
0x0226, 0x0100,
0x021E, 0x0000,
0x081C, 0x0708,  ////// T3-Probegin 0718
0x081E, 0x0706,  ////// T3-Post     0F00
0x080E, 0x0000,
0x0B00, 0x0001,
0x0B02, 0x0200,
0x0B08, 0x0000,
...
#if USE_TNP_BURST
////// 00 OK
static const u16 HM2InitBurstA[] ={
0x126F,   ////Frist 0x6F12  00
0x0000,
0x0000,
0x0000,
0x0000,
...
////// 02 swpage ok
static const u16 HM2InitBurstB[] ={
0x126F,             ////Frist 0x6F12 02   0x6028, 0x2002,   0x602A, 0x5580,
0x0000,
0x0000,
0x0000,
0x0000,
...
/////// 01 swpage ok
static kal_uint16 HM2InitBurstN01[] = {
0x6028, 0x2002,  ///0x2002 01
0x602A, 0x557C,
0x6F12, 0x0000,
0x6F12, 0x0000,
0x602A, 0x548C,
...
///// 03 Global case1 ok
static kal_uint16 HM2InitBurstN02[] = {
0x6028, 0x2000,     /////0x2000
0x602A, 0x2AC8,
0x6F12, 0x001E,
0x602A, 0x2ACE,
0x6F12, 0x000D,
...
0x6F12, 0xF438,
0x602A, 0x2228,
0x6F12, 0x3FFE,  ///power noise 0x3F0A  3F36
0x6F12, 0x3FFE,  ///power noise 0x3F0A  3F36
0x602A, 0x2230,
0x6F12, 0x0000,
0x6F12, 0xF43A,
...
static void sensor_init(void)
{
	...
	PK_DBG("start \n");
	 write_cmos_sensor_16_16(0x6028,0x4000);
	 write_cmos_sensor_16_16(0x0000,0x0F20);
	 write_cmos_sensor_16_16(0x0000,0x1AD2);
	 write_cmos_sensor_16_16(0x001E,0x7385);
	 write_cmos_sensor_16_16(0x6028,0x4000);
	 write_cmos_sensor_16_16(0x6018,0x0001);
	 mdelay(8);
	 write_cmos_sensor_16_16(0x7004,0x1964);  //MCLK
	 write_cmos_sensor_16_16(0x7002,0x2008);
	 write_cmos_sensor_16_16(0x707E,0x10F6); //MCLK
	 write_cmos_sensor_16_16(0x6014,0x0001);
	 mdelay(10);
	 write_cmos_sensor_16_16(0x6028,0x2000);
	 write_cmos_sensor_16_16(0x602A,0x37C0);
	 write_cmos_sensor_16_16(0x6F12,0x0101);
	 write_cmos_sensor_16_16(0x6028,0x4000);
	 write_cmos_sensor_16_16(0x7002,0x0008);
	 mdelay(10);
	 //write_cmos_sensor_16_16(0x6214,0xE9F0);//carl
	 //write_cmos_sensor_16_16(0x6218,0x0110);

	 #if USE_TNP_BURST
	write_cmos_sensor_16_16(0x6028, 0x2002);
	write_cmos_sensor_16_16(0x602A, 0x4FC4);
	PK_DBG("Using Burst Mode for TNP (%d)\n",(int)sizeof(HM2InitBurstA));
	iWriteRegI2C((u8*)HM2InitBurstA , (u16)sizeof(HM2InitBurstA), imgsensor.i2c_write_id);

	 table_write_cmos_sensor(HM2InitBurstN01,sizeof(HM2InitBurstN01) / sizeof(kal_uint16));

	 write_cmos_sensor_16_16(0x6028, 0x2002);
	 write_cmos_sensor_16_16(0x602A, 0x5580);
	PK_DBG("Using Burst Mode for TNP (%d)\n",(int)sizeof(HM2InitBurstB));
	iWriteRegI2C((u8*)HM2InitBurstB , (u16)sizeof(HM2InitBurstB), imgsensor.i2c_write_id);

	table_write_cmos_sensor(HM2InitBurstN02,sizeof(HM2InitBurstN02) / sizeof(kal_uint16));

	//////Fast change init part
  #endif
	//VOD
	write_cmos_sensor_16_16(0x6028, 0x4000);
	write_cmos_sensor_16_16(0x6B06, 0xE180);
		...
		do {
			*sensor_id = read_cmos_sensor_16_16(0x0000);
			...
			if ( *sensor_id == imgsensor_info.sensor_id) {
				...
				vivo_otp_read_when_power_on = s5khm2sp03_otp_read();
				PK_DBG("cfx_add:end read eeprom ---vivo_otp_read_when_power_on = %d,OTP_ERROR_CODE=%d\n", vivo_otp_read_when_power_on, S5KHM2SP03_OTP_ERROR_CODE);
				/*vivo caofeixiang add end*/
				return ERROR_NONE;
			}
	...
	kal_uint32 shutter_2ndframe, kal_uint32 gain_2ndframe)
{
	...
	switch (scenario_id) {
		...
		case MSDK_SCENARIO_ID_CAMERA_CAPTURE_JPEG:
		{
			pr_info("seamless switch to binning mode!\n");
			...
			table_write_cmos_sensor(hm2_seamless_capture,
			sizeof(hm2_seamless_capture) / sizeof(kal_uint16));
		...
		case MSDK_SCENARIO_ID_CUSTOM8:
		{
			...
			pr_info("seamless switch to roi mode!\n");
			...
			table_write_cmos_sensor(hm2_seamless_custom1,
			sizeof(hm2_seamless_custom1) / sizeof(kal_uint16));
				  ...
				  UINT8 *feature_para, UINT32 *feature_para_len)
{
	...
	case SENSOR_FEATURE_GET_GAIN_RANGE_BY_SCENARIO:
		*(feature_data + 1) = imgsensor_info.min_gain;
		switch (*feature_data) {
			case MSDK_SCENARIO_ID_CUSTOM5:
			case MSDK_SCENARIO_ID_CUSTOM8:
				*(feature_data + 2) = 16 * imgsensor_info.min_gain;
				break;
			default:
				*(feature_data + 2) = 40 * imgsensor_info.min_gain;
				break;
		}
		break;
	...
	case SENSOR_FEATURE_GET_REGISTER:
		...
		PK_DBG("[yzr]SENSOR_FEATURE_GET_REGISTER sensor_reg_data->RegAddr = 0x%x, sensor_reg_data->RegData = 0x%x\n", sensor_reg_data->RegAddr, sensor_reg_data->RegData);
		break;
	...
	case SENSOR_FEATURE_GET_PDAF_INFO:
		...
		switch (*feature_data) {
			...
			case MSDK_SCENARIO_ID_SLIM_VIDEO:
			case MSDK_SCENARIO_ID_HIGH_SPEED_VIDEO:
				memcpy((void *)PDAFinfo,(void *)&imgsensor_pd_2Bin_info,sizeof(struct SET_PD_BLOCK_INFO_T));
				break;

			case MSDK_SCENARIO_ID_CUSTOM2:
			case MSDK_SCENARIO_ID_CUSTOM3:
			case MSDK_SCENARIO_ID_CUSTOM4:
				memcpy((void *)PDAFinfo,(void *)&imgsensor_4k_pd_info,sizeof(struct SET_PD_BLOCK_INFO_T));
				break;

			case MSDK_SCENARIO_ID_CUSTOM7:
			case MSDK_SCENARIO_ID_CUSTOM10:
			case MSDK_SCENARIO_ID_VIDEO_PREVIEW:
				memcpy((void *)PDAFinfo,(void *)&imgsensor_video_pd_info,sizeof(struct SET_PD_BLOCK_INFO_T));
				break;

			case MSDK_SCENARIO_ID_CUSTOM8:
				memcpy((void *)PDAFinfo,(void *)&imgsensor_roi_pd_info,sizeof(struct SET_PD_BLOCK_INFO_T));
				break;
...
/*
    ...
    */
    case SENSOR_FEATURE_GET_VC_INFO:
        ...
        case MSDK_SCENARIO_ID_CUSTOM9:
		case MSDK_SCENARIO_ID_CAMERA_CAPTURE_JPEG:
		case MSDK_SCENARIO_ID_CAMERA_PREVIEW: ///4000X3000 mode
		    memcpy((void *)pvcinfo, (void *)&SENSOR_VC_INFO[0], sizeof(struct SENSOR_VC_INFO_STRUCT));
		    break;

        case MSDK_SCENARIO_ID_CUSTOM7:
        case MSDK_SCENARIO_ID_CUSTOM10:
        case MSDK_SCENARIO_ID_VIDEO_PREVIEW: //4000*2256
		...
		case MSDK_SCENARIO_ID_HIGH_SPEED_VIDEO:
		case MSDK_SCENARIO_ID_SLIM_VIDEO: ///1920x1080 mode
			  memcpy((void *)pvcinfo, (void *) &SENSOR_VC_INFO[3], sizeof(struct SENSOR_VC_INFO_STRUCT));
		    break;

		case MSDK_SCENARIO_ID_CUSTOM8: ///4000x3000 roi mode
	...
	case SENSOR_FEATURE_GET_CUSTOM_INFO:
	    printk("SENSOR_FEATURE_GET_CUSTOM_INFO information type:%lld  S5KHM2SP03_OTP_ERROR_CODE:%d \n", *feature_data,S5KHM2SP03_OTP_ERROR_CODE);
		switch (*feature_data) {
			case 0:    //info type: otp state
				...
				if (*feature_para_len >= sizeof(MUINT32)*13 + 2) {
					*(MUINT32 *)(uintptr_t)(*(feature_data+1)) = S5KHM2SP03_OTP_ERROR_CODE;//otp_state
					memcpy( feature_data+2, sn_inf_main_s5khm2sp03, sizeof(MUINT32)*13);
					memcpy( feature_data+10, material_inf_main_s5khm2sp03, sizeof(MUINT32)*4);
					memcpy( feature_data+12, af_calib_inf_main_s5khm2sp03, sizeof(MUINT32)*6);
					#if 0
							for (i = 0 ; i<12 ; i++ ){
	...
	case SENSOR_FEATURE_GET_FRAME_CTRL_INFO_BY_SCENARIO:
		 ...
		 */
		switch (*feature_data) {
			case MSDK_SCENARIO_ID_CUSTOM5://only fullsize and roi use 12
			case MSDK_SCENARIO_ID_CUSTOM8:
				*(feature_data + 1) = 1;
				*(feature_data + 2) = 12;   ////imgsensor_info.margin
				break;
			default:
				*(feature_data + 1) = 1; //binning mode use 24
				*(feature_data + 2) = 24;   ////imgsensor_info.margin
				break;
		}
		break;
...
UINT32 S5KHM2SP03PD2163_MIPI_RAW_SensorInit(
