...
static struct imgsensor_info_struct imgsensor_info = {
	.sensor_id = S5KJN1SQ03PD2131_SENSOR_ID,
...
MUINT32  af_calib_inf_main_s5kjn1sq03pd2131[6];
MUINT32 crosstalk_data_PD2131[8006];  /*0 flag   1-836 data*/ 
    ...
    */
			...
			if (*feature_para_len >= sizeof(MUINT32)*13 + 2) {
			    *(MUINT32 *)(uintptr_t)((feature_data+1)) = S5KJN1SQ03_OTP_ERROR_CODE;//otp_state
				...
				memcpy( feature_data+10, material_inf_main_s5kjn1sq03, sizeof(MUINT32)*4);
                                memcpy( feature_data+12, af_calib_inf_main_s5kjn1sq03pd2131, sizeof(MUINT32)*6); 
				#if 0
						for (i = 0 ; i<12 ; i++ ){
        ...
        case SENSOR_FEATURE_GET_4CELL_DATA:/*get 4 cell data from eeprom*/
	{
		...
		if (type == FOUR_CELL_CAL_TYPE_XTALK_CAL) {
			...
			data[1] = 0x1F;
			for(i = 0; i< 8006 ; i++)
			data[2 + i] = crosstalk_data_PD2131[i];
...
UINT32 S5KJN1SQ03PD2131_MIPI_RAW_SensorInit(
