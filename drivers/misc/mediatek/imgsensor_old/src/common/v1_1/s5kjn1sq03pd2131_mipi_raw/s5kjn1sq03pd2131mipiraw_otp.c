...
#include "s5kjn1sq03pd2131mipiraw_Sensor.h"
...
extern MUINT32  af_calib_inf_main_s5kjn1sq03pd2131[6];
extern MUINT32 crosstalk_data_PD2131[8006];  /*0 flag   1-606 data*/ 
	...
	if (check_if_group_valid == 0x01) { /****all the data is valid****/
		...
		if (vivo_otp_data_s5kjn1sq03[Af_checksum_addr] != checksum) {
			...
			return 0;
                ...
                af_calib_inf_main_s5kjn1sq03pd2131[0] = vivo_otp_data_s5kjn1sq03[Af_addr + 7]<<8| vivo_otp_data_s5kjn1sq03[Af_addr + 8];
		af_calib_inf_main_s5kjn1sq03pd2131[1] = vivo_otp_data_s5kjn1sq03[Af_addr + 7]<<8| vivo_otp_data_s5kjn1sq03[Af_addr + 8];
		af_calib_inf_main_s5kjn1sq03pd2131[2] = vivo_otp_data_s5kjn1sq03[Af_addr + 9]<<8| vivo_otp_data_s5kjn1sq03[Af_addr + 10];
		af_calib_inf_main_s5kjn1sq03pd2131[3] = vivo_otp_data_s5kjn1sq03[Af_addr + 9]<<8| vivo_otp_data_s5kjn1sq03[Af_addr + 10];
		af_calib_inf_main_s5kjn1sq03pd2131[4] = vivo_otp_data_s5kjn1sq03[Af_addr+ 11]<<8| vivo_otp_data_s5kjn1sq03[Af_addr + 12];
		af_calib_inf_main_s5kjn1sq03pd2131[5] = vivo_otp_data_s5kjn1sq03[Af_addr+ 11]<<8| vivo_otp_data_s5kjn1sq03[Af_addr + 12];
                LOG_INF("af1 = %d, af2= %d af3= %d af4= %d af5= %d af6= %d\n",af_calib_inf_main_s5kjn1sq03pd2131[0],af_calib_inf_main_s5kjn1sq03pd2131[1],af_calib_inf_main_s5kjn1sq03pd2131[2],af_calib_inf_main_s5kjn1sq03pd2131[3],af_calib_inf_main_s5kjn1sq03pd2131[4],af_calib_inf_main_s5kjn1sq03pd2131[5]);
		/****AWB_checksum****/
		checksum = 0;
		...
		if (vivo_otp_data_s5kjn1sq03[XTC_cal_checksum_addr] != checksum) {
			...
			return 0;
                ...
                for (i = 0; i < 2612; i++) {
			crosstalk_data_PD2131[i]=vivo_otp_data_s5kjn1sq03[0x1a40+i];
		}
		...
		if (vivo_otp_data_s5kjn1sq03[SensorXTC_cal_checksum_addr] != checksum) {
			...
			return 0;
                ...
                for (i = 0; i < 768; i++) {
			crosstalk_data_PD2131[2612+i]=vivo_otp_data_s5kjn1sq03[0x2476+i];
		}
		...
		if (vivo_otp_data_s5kjn1sq03[PDXTC_checksum_addr] != checksum) {
			...
			return 0;
                ...
                for (i = 0; i < 4000; i++) {
			crosstalk_data_PD2131[3380+i]=vivo_otp_data_s5kjn1sq03[0x2778+i];
		}
		...
		if (vivo_otp_data_s5kjn1sq03[SW_GGC_checksum_addr] != checksum) {
			...
			return 0;
                ...
                for (i = 0; i < 626; i++) {
			crosstalk_data_PD2131[7380+i]=vivo_otp_data_s5kjn1sq03[0x371A+i];
		}

		for (i = 0; i < 8006; i++) {
			LOG_INF("crosstalk_data_PD2131[%d] =0x%x\n", i,crosstalk_data_PD2131[i]);
		}
