...
#define DW9781C_REG_OIS_FW_CHECKSUM_CAL     0x7005  // fw checksum calculated value after dsp on
#define DW9781C_REG_OIS_FW_CHECKSUM_STORED  0x7007  // fw checksum pre-restored in IC
...
#define DW9781C_REG_OIS_DD_CTL              0x703C
#define DW9781C_REG_OIS_DD_XTIMES           0x7286
#define DW9781C_REG_OIS_DD_YTIMES           0x7287
...
#define DW9781C_REG_OIS_SMOOTH_DELAY        0x73E7  // 1 for 0.4ms, ther larger the smoother,default 13
#define DW9781C_REG_OIS_SMOOTH_STEP         0x73E8  // 1024 for 100%, the smaller the smoother,default 102
...
enum DW9781C_mode {
	...
	DW9781C_SINEWAVEY_MODE   = 0x8004,
	DW9781C_SINEWAVEX_MODE   = 0x8005,
	DW9781C_CIRCLEWAVE_MODE  = 0x8006,
};
