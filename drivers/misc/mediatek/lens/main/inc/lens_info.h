...
#define MAX_NUM_OF_LENS 36 //change by changcheng
...
#define AFDRV_AK7377AFPD2133 "AK7377AFPD2133"//xyw add pd2133 af
...
#define OISDRV_DW9786 "DW9786"
#define OISDRV_RUMBAS4SW "RUMBAS4SW"
#define OISDRV_LC898129 "LC898129"
...
#define AFICO_X_OIS_SETSMOOTH       _IOWR('A', 75, struct ois_smooth_info)
#define AFICO_X_OIS_INIT_SLAVE      _IOWR('A', 76, int)
#define AFICO_X_OIS_VSYNC           _IOWR('A', 77, int)
#define AFICO_X_OIS_READY_CHECK     _IOWR('A', 78, int)
#define AFICO_X_OIS_LOG_LEVEL       _IOWR('A', 79, int)
#define AFICO_X_OIS_GETLOOPGAIN     _IOWR('A', 80, int[2])
#define AFICO_X_OIS_GETDDTIMES      _IOWR('A', 81, int[2])
#define AFICO_X_OIS_SETAFDRIFT      _IOWR('A', 82, struct ois_af_drift_param)
#define AFICO_X_OIS_SETSERVO        _IOWR('A', 83, int)
#define AFICO_X_OIS_ACTSTROKELIMIT  _IOWR('A', 84, int)
#define AFICO_X_OIS_DEPENDENCY_INIT _IOWR('A', 85, int)
#define AFICO_X_OIS_END             _IOWR('A', 86, int)
#define AFICO_X_OIS_SUPPORT         _IOWR('A', 100, int)
/*add end*/
