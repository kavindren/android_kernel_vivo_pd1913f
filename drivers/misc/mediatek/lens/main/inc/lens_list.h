...
#define DW9781COISAF_SetI2Cclient DW9781COISAF_SetI2Cclient_Main
#define DW9781COISAF_Ioctl DW9781COISAF_Ioctl_Main
#define DW9781COISAF_Release DW9781COISAF_Release_Main
#define DW9781COISAF_PowerDown DW9781COISAF_PowerDown_Main
#define DW9781COISAF_GetFileName DW9781COISAF_GetFileName_Main
extern int DW9781COISAF_SetI2Cclient(struct i2c_client *pstAF_I2Cclient,
				 spinlock_t *pAF_SpinLock, int *pAF_Opened);
extern long DW9781COISAF_Ioctl(struct file *a_pstFile, unsigned int a_u4Command,
			   unsigned long a_u4Param);
extern int DW9781COISAF_Release(struct inode *a_pstInode, struct file *a_pstFile);
extern int DW9781COISAF_PowerDown(struct i2c_client *pstAF_I2Cclient,
				int *pAF_Opened);
extern int DW9781COISAF_GetFileName(unsigned char *pFileName);
...
#define AK7377AF_SetI2Cclient AK7377AF_SetI2Cclient_Main
#define AK7377AF_Ioctl AK7377AF_Ioctl_Main
#define AK7377AF_Release AK7377AF_Release_Main
#define AK7377AF_PowerDown AK7377AF_PowerDown_Main
#define AK7377AF_GetFileName AK7377AF_GetFileName_Main
...
//xyw add pd2133 af start
#define AK7377AFPD2133_SetI2Cclient AK7377AFPD2133_SetI2Cclient_Main
#define AK7377AFPD2133_Ioctl AK7377AFPD2133_Ioctl_Main
#define AK7377AFPD2133_Release AK7377AFPD2133_Release_Main
#define AK7377AFPD2133_PowerDown AK7377AFPD2133_PowerDown_Main
#define AK7377AFPD2133_GetFileName AK7377AFPD2133_GetFileName_Main
extern int AK7377AFPD2133_SetI2Cclient(struct i2c_client *pstAF_I2Cclient,
				 spinlock_t *pAF_SpinLock, int *pAF_Opened);
extern long AK7377AFPD2133_Ioctl(struct file *a_pstFile, unsigned int a_u4Command,
			   unsigned long a_u4Param);
extern int AK7377AFPD2133_Release(struct inode *a_pstInode, struct file *a_pstFile);
extern int AK7377AFPD2133_PowerDown(struct i2c_client *pstAF_I2Cclient,
				int *pAF_Opened);
extern int AK7377AFPD2133_GetFileName(unsigned char *pFileName);
//xyw add pd2133 af end
