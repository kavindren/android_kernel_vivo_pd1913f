...
#define GT9772M2AF_SetI2Cclient GT9772M2AF_SetI2Cclient_Sub
#define GT9772M2AF_Ioctl GT9772M2AF_Ioctl_Sub
#define GT9772M2AF_Release GT9772M2AF_Release_Sub
#define GT9772M2AF_GetFileName GT9772M2AF_GetFileName_Sub
extern int GT9772M2AF_SetI2Cclient(struct i2c_client *pstAF_I2Cclient,
				 spinlock_t *pAF_SpinLock, int *pAF_Opened);
extern long GT9772M2AF_Ioctl(struct file *a_pstFile, unsigned int a_u4Command,
			   unsigned long a_u4Param);
extern int GT9772M2AF_Release(struct inode *a_pstInode, struct file *a_pstFile);
extern int GT9772M2AF_GetFileName(unsigned char *pFileName);
