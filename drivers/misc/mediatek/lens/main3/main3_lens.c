...
static struct stAF_DrvList g_stAF_DrvList[MAX_NUM_OF_LENS] = {
	{1, AFDRV_DW9786OISAF, DW9786OISAF_SetI2Cclient, DW9786OISAF_Ioctl,
	 DW9786OISAF_Release, DW9786OISAF_GetFileName, NULL},
#if 0
	...
	{1, AFDRV_GT9772WIDEAF, GT9772WIDEAF_SetI2Cclient, GT9772WIDEAF_Ioctl,
	 GT9772WIDEAF_Release, GT9772WIDEAF_GetFileName, NULL},
};
		     ...
		     unsigned long a_u4Param)
{
	...
	default:
		...
		i4RetValue = ois_interface_dispatcher_tele(a_u4Command, (__user void *)(a_u4Param));
		break;
	}
...
/*wubin add for ois open*/
#if defined(CONFIG_MTK_CAM_PD2135)
	ois_interface_create_tele(g_pstAF_I2Cclient, lens_device, OISDRV_DW9786);
#endif
	ois_interface_dispatcher_tele(AFIOC_X_OIS_INIT, NULL);
	/*add end*/
...
static int AF_Release(struct inode *a_pstInode, struct file *a_pstFile)
{
	...
	/* ------------------------- */
	/*wubin add for ois release*/
	ois_interface_dispatcher_tele(AFIOC_X_OIS_DEINIT, NULL);
...
/*wubin add*/
#if defined(CONFIG_MTK_CAM_PD2135)
	i4RetValue =ois_interface_create_tele(g_pstAF_I2Cclient, lens_device, OISDRV_DW9786);
#endif
	/*add end*/
