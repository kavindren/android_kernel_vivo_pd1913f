...
static int initAF(void)
{
	...
	ois_interface_dispatcher(OIS_LC898129, AFIOC_X_OIS_INIT, NULL);
#endif
	/*add end*/
...
#if 0//def CONFIG_MTK_CAM_PD2083F_EX
		i4RetValue = ois_interface_dispatcher(OIS_LC898129, a_u4Command, (__user void *)(a_u4Param));
#else
		i4RetValue = -EPERM;
#endif
		/*add end*/
...
int LC898129OISAF_Release(struct inode *a_pstInode, struct file *a_pstFile)
{
	...
	LOG_INF("End\n");
#if 0//def CONFIG_MTK_CAM_PD2083F_EX
	ois_interface_dispatcher(OIS_LC898129, AFIOC_X_OIS_DEINIT, NULL);
#endif
	return 0;
}
