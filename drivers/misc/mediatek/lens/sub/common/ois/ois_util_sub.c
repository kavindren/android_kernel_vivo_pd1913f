...
int ois_i2c_write_sub(struct i2c_client *client, u16 addr, u16 data)//16
{
	struct i2c_msg msg[1]  = {0,};
	char           buf[4]  = {0,};
	int            ret     = 0;
...
int ois_i2c_write_block_sub(struct i2c_client *client, u16 addr,
...
int ois_i2c_read_sub(struct i2c_client *client, u16 addr, u16 *data)//16
{
	int            ret          = 0;
	struct i2c_msg msg[2];
	u8             addr_buf[2]  = {0,};
...
int ois_i2c_read_block_sub(struct i2c_client *client,
