...
#endif
#else //CONFIG_MTK_CAM_PD2083F_EX
/* PMIC */
#if 0 // close by zhangyinpeng for use AFRegulatorCtrl of main_lens.c 
//#if !defined(CONFIG_MTK_LEGACY)
...
#ifdef CONFIG_MTK_CAM_PD2083F_EX
		i4RetValue = ois_interface_dispatcher_sub(a_u4Command, (__user void *)(a_u4Param));
#endif
		break;
	}
	/*modified end*/
...
#endif
#ifdef CONFIG_MTK_CAM_PD2083F_EX
	ois_interface_create_sub(g_pstAF_I2Cclient, lens_device, OISDRV_LC898129);
	ois_interface_dispatcher_sub(AFIOC_X_OIS_INIT, NULL);
#endif
...
#ifdef CONFIG_MTK_CAM_PD2083F_EX
	ois_interface_dispatcher_sub(AFIOC_X_OIS_DEINIT, NULL);
...
late_initcall(SUBAF_i2C_init);//vivo
