...
#define DW9714S2AF_SetI2Cclient DW9714S2AF_SetI2Cclient_Main2
#define DW9714S2AF_Ioctl DW9714S2AF_Ioctl_Main2
#define DW9714S2AF_Release DW9714S2AF_Release_Main2
#define DW9714S2AF_GetFileName DW9714S2AF_GetFileName_Main2
extern int DW9714S2AF_SetI2Cclient(struct i2c_client *pstAF_I2Cclient,
				  spinlock_t *pAF_SpinLock, int *pAF_Opened);
extern long DW9714S2AF_Ioctl(struct file *a_pstFile, unsigned int a_u4Command,
			    unsigned long a_u4Param);
extern int DW9714S2AF_Release(struct inode *a_pstInode, struct file *a_pstFile);
extern int DW9714S2AF_GetFileName(unsigned char *pFileName);

extern void AFRegulatorCtrl(int Stage);
extern int set_pinctrl_af_low(void);
extern int set_pinctrl_af_high(void);
#endif
