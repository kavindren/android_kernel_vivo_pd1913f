...
#define MT6360_MASK_HZ_MODE    BIT(2)
#define MT6360_SHFT_HZ_MODE    (2)
...
#define MT6360_DCP_QC		BIT(3)

/* MT6360_PMU_QC_CTRL1 : 0x23 */
#define MT6360_MASK_QC_EN	BIT(7)
#define MT6360_MASK_QC20_REQ_SET	(0x70)
