...
#define SEC_NFC_SHUTDOWN        _IOW(SEC_NFC_MAGIC, 9, unsigned int)
#endif

#ifdef CONFIG_VIVO_NFC_FACTORY_SMT_TEST
#define SEC_NFC_FACTORY_SMT_TEST_BEGIN      _IOW(SEC_NFC_MAGIC, 97, unsigned int)
#define SEC_NFC_FACTORY_SMT_TEST_END       _IOW(SEC_NFC_MAGIC, 98, unsigned int)
#endif
