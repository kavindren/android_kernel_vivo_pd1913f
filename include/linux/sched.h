...
#define PFA_IN_DROP_CACHES_OTA	25
#define PFA_IN_DROP_CACHES	26
#endif
...
#ifdef CONFIG_RSC_ION_OPT
TASK_PFA_TEST(IN_DROP_CACHES_OTA, in_drop_caches_ota)
TASK_PFA_SET(IN_DROP_CACHES_OTA, in_drop_caches_ota)
TASK_PFA_CLEAR(IN_DROP_CACHES_OTA, in_drop_caches_ota)

TASK_PFA_TEST(IN_DROP_CACHES, in_drop_caches)
TASK_PFA_SET(IN_DROP_CACHES, in_drop_caches)
TASK_PFA_CLEAR(IN_DROP_CACHES, in_drop_caches)
#endif
