...
/*used for hold the task_lock*/
static void sync_task_rss_tasklock(struct task_struct *task)
{
	struct mm_struct *mm;
	int i;
...
static void dump_tasks(struct mem_cgroup *memcg, const nodemask_t *nodemask)
{
	...
	for_each_process(p) {
		...
		/*
		 * B200508-590 native task emdlogger1
		 * VmSwap:1049068 kB > VmSize:298240 kB
		 * do counter updates before oom
		 */
		sync_task_rss_tasklock(task);
