...
static inline const char *i2s_type_to_string(enum mtk_spk_i2s_type type)
{
    switch (type) {
		ENUM_TYPE_CASE(MTK_SPK_I2S_TYPE_INVALID)
		ENUM_TYPE_CASE(MTK_SPK_I2S_0)
		ENUM_TYPE_CASE(MTK_SPK_I2S_1)
		ENUM_TYPE_CASE(MTK_SPK_I2S_2)
		ENUM_TYPE_CASE(MTK_SPK_I2S_3)
		ENUM_TYPE_CASE(MTK_SPK_I2S_5)
		ENUM_TYPE_CASE(MTK_SPK_I2S_6)
		ENUM_TYPE_CASE(MTK_SPK_I2S_7)
		ENUM_TYPE_CASE(MTK_SPK_I2S_8)
		ENUM_TYPE_CASE(MTK_SPK_I2S_9)
		ENUM_TYPE_CASE(MTK_SPK_TINYCONN_I2S_0)
		ENUM_TYPE_CASE(MTK_SPK_TINYCONN_I2S_1)
		ENUM_TYPE_CASE(MTK_SPK_TINYCONN_I2S_2)
		ENUM_TYPE_CASE(MTK_SPK_TINYCONN_I2S_3)
		ENUM_TYPE_CASE(MTK_SPK_TINYCONN_I2S_5)
		ENUM_TYPE_CASE(MTK_SPK_TINYCONN_I2S_6)
		ENUM_TYPE_CASE(MTK_SPK_TINYCONN_I2S_7)
		ENUM_TYPE_CASE(MTK_SPK_TINYCONN_I2S_8)
		ENUM_TYPE_CASE(MTK_SPK_TINYCONN_I2S_9)
		ENUM_TYPE_CASE(MTK_SPK_I2S_TYPE_NUM)
	}
    return "Unsupported I2S";
}
