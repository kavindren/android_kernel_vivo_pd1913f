...
******************************************************************************/
static void __init mt6853_proc_dump_register(struct mtk_base_afe *afe)
{
	...
	entry = proc_create_data("mtksocaudio", 0664, NULL, &mt6853_debugfs_ops, afe);
	if (!entry)
