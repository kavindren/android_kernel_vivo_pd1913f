...
/* vivo audio dxl add for create debug node start */
#include <linux/proc_fs.h>
#include <linux/uidgid.h>
/* vivo audio dxl add for create debug node end */
...
******************************************************************************/
static void __init mt6877_proc_dump_register(struct mtk_base_afe *afe)
{
	...
	entry = proc_create_data("mtksocaudio", 0664, NULL, &mt6877_debugfs_ops, afe);
	if (!entry)
...
static int mt6877_afe_pcm_dev_probe(struct platform_device *pdev)
{
	...
	/* vivo audio dxl add for create debug node */
	mt6877_proc_dump_register(afe);
