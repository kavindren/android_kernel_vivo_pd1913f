...
int tfa98xx_init_dbg(char *buffer, int size)
{
	...
	if (tfa98xx_priv->tfa->is_probus_device) {
		...
		list_all_tfa98xx (tfa98xx) {
			...
			ret = tfa98xx_calibration_done (tfa98xx->imped_val, tfa98xx);
			tfa98xx->calibration = (ret > 0 ? 1 : 0);
			done &= ret;
...
static int tfa98xx_load_container1(struct tfa98xx *tfa98xx)
{
...
{
	struct tfa98xx *tfa98xx = (struct tfa98xx *)file->private_data;
	TfaContainer_t *old_tfa98xx_container = NULL;
	enum Tfa98xx_Error ret;
	char buf[32];
	...
	ret = tfa98xx_load_container1(tfa98xx);
...
static void tfa98xx_debug_init(struct tfa98xx *tfa98xx, struct i2c_client *i2c)
{
	...
	proc_create_data("fw-debug", S_IRUGO|S_IWUGO, tfa98xx->dbg_dir,
					&tfa98xx_dbgfs_fw_debug_fops, tfa98xx);
...
static int tfa98xx_create_controls(struct tfa98xx *tfa98xx)
{
	...
	nr_controls = 3; /* Profile and stop control and tfa98xx_mute_ctrl */
